...
public class ConsentResource {
    ...
    public ConsentResource(ConsentService consentService, ConsentQueryService consentQueryService) {
    ...
    public ResponseEntity<ConsentDTO> createConsent(@Valid @RequestBody ConsentDTO consentDTO) throws URISyntaxException {
        ...
        ConsentDTO result = consentService.save(consentDTO);
    ...
    public ResponseEntity<ConsentDTO> getConsent(@PathVariable Long id) {
        ...
        Optional<ConsentDTO> consentDTO = consentService.findOne(id);
