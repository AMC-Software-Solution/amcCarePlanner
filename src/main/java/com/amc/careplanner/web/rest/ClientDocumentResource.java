...
public class ClientDocumentResource {
    ...
    public ClientDocumentResource(ClientDocumentService clientDocumentService, ClientDocumentQueryService clientDocumentQueryService) {
    ...
    public ResponseEntity<ClientDocumentDTO> createClientDocument(@Valid @RequestBody ClientDocumentDTO clientDocumentDTO) throws URISyntaxException {
        ...
        ClientDocumentDTO result = clientDocumentService.save(clientDocumentDTO);
    ...
    public ResponseEntity<ClientDocumentDTO> getClientDocument(@PathVariable Long id) {
        ...
        Optional<ClientDocumentDTO> clientDocumentDTO = clientDocumentService.findOne(id);
