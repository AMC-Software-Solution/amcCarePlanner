...
public class EmployeeLocationResource {
    ...
    public EmployeeLocationResource(EmployeeLocationService employeeLocationService, EmployeeLocationQueryService employeeLocationQueryService) {
    ...
    public ResponseEntity<EmployeeLocationDTO> createEmployeeLocation(@Valid @RequestBody EmployeeLocationDTO employeeLocationDTO) throws URISyntaxException {
        ...
        EmployeeLocationDTO result = employeeLocationService.save(employeeLocationDTO);
    ...
    public ResponseEntity<EmployeeLocationDTO> getEmployeeLocation(@PathVariable Long id) {
        ...
        Optional<EmployeeLocationDTO> employeeLocationDTO = employeeLocationService.findOne(id);
