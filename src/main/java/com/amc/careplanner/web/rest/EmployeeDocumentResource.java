...
public class EmployeeDocumentResource {
    ...
    public EmployeeDocumentResource(EmployeeDocumentService employeeDocumentService, EmployeeDocumentQueryService employeeDocumentQueryService) {
    ...
    public ResponseEntity<EmployeeDocumentDTO> createEmployeeDocument(@Valid @RequestBody EmployeeDocumentDTO employeeDocumentDTO) throws URISyntaxException {
        ...
        EmployeeDocumentDTO result = employeeDocumentService.save(employeeDocumentDTO);
