...
public class CarerClientRelationResourceExt extends CarerClientRelationResource{
    ...
    public CarerClientRelationResourceExt(CarerClientRelationServiceExt carerClientRelationServiceExt, CarerClientRelationQueryService carerClientRelationQueryService) {
