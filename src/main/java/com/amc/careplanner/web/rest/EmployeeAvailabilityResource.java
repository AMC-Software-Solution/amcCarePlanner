...
public class EmployeeAvailabilityResource {
    ...
    public ResponseEntity<EmployeeAvailabilityDTO> createEmployeeAvailability(@Valid @RequestBody EmployeeAvailabilityDTO employeeAvailabilityDTO) throws URISyntaxException {
    ...
    public ResponseEntity<EmployeeAvailabilityDTO> updateEmployeeAvailability(@Valid @RequestBody EmployeeAvailabilityDTO employeeAvailabilityDTO) throws URISyntaxException {
