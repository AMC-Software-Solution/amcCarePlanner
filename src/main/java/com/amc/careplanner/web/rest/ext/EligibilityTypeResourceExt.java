...
public class EligibilityTypeResourceExt extends EligibilityTypeResource{

    private final Logger log = LoggerFactory.getLogger(EligibilityTypeResourceExt.class);
     ...
     */
    @PostMapping("/create-eligibility-type-by-client-id")
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/update-eligibility-type-by-client-id")
     ...
     */
    @GetMapping("/get-all-eligibility-type-by-client-id")
     ...
     */
    @GetMapping("/get-eligibility-type-by-client-id/{id}")
     ...
     */
    @DeleteMapping("/delete-eligibility-type-by-client-id/{id}")
