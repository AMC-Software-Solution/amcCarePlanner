...
import com.amc.careplanner.web.rest.EmployeeAvailabilityResource;
import com.amc.careplanner.web.rest.errors.BadRequestAlertException;
import com.amc.careplanner.service.dto.EmployeeAvailabilityDTO;
import com.amc.careplanner.service.ext.EmployeeAvailabilityServiceExt;
...
public class EmployeeAvailabilityResourceExt extends EmployeeAvailabilityResource{

    private final Logger log = LoggerFactory.getLogger(EmployeeAvailabilityResourceExt.class);
    ...
    private final EmployeeAvailabilityServiceExt employeeAvailabilityServiceExt;

    private final EmployeeAvailabilityQueryService employeeAvailabilityQueryService;

    public EmployeeAvailabilityResourceExt(EmployeeAvailabilityServiceExt employeeAvailabilityServiceExt, EmployeeAvailabilityQueryService employeeAvailabilityQueryService) {
    	super(employeeAvailabilityServiceExt,employeeAvailabilityQueryService);
        this.employeeAvailabilityServiceExt = employeeAvailabilityServiceExt;
    ...
    public ResponseEntity<EmployeeAvailabilityDTO> createEmployeeAvailability(@RequestBody EmployeeAvailabilityDTO employeeAvailabilityDTO) throws URISyntaxException {
        ...
        EmployeeAvailabilityDTO result = employeeAvailabilityServiceExt.save(employeeAvailabilityDTO);
