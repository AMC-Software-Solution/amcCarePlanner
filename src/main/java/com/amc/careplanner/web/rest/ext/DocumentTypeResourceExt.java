...
import com.amc.careplanner.web.rest.DocumentTypeResource;
...
/**
 * REST controller for managing {@link com.amc.careplanner.domain.DocumentType}.
 */
@RestController
@RequestMapping("/api/v1")
public class DocumentTypeResourceExt extends DocumentTypeResource{

    private final Logger log = LoggerFactory.getLogger(DocumentTypeResourceExt.class);
    ...
    private final DocumentTypeServiceExt documentTypeServiceExt;

    private final DocumentTypeQueryService documentTypeQueryService;

    public DocumentTypeResourceExt(DocumentTypeServiceExt documentTypeServiceExt, DocumentTypeQueryService documentTypeQueryService) {
    	super(documentTypeServiceExt,documentTypeQueryService);
        this.documentTypeServiceExt = documentTypeServiceExt;
    ...
    public ResponseEntity<DocumentTypeDTO> createDocumentType(@Valid @RequestBody DocumentTypeDTO documentTypeDTO) throws URISyntaxException {
        ...
        DocumentTypeDTO result = documentTypeServiceExt.save(documentTypeDTO);
