...
@RestController
@RequestMapping("/api")
public class MedicalContactResource {

    private final Logger log = LoggerFactory.getLogger(MedicalContactResource.class);
    ...
    private final MedicalContactService medicalContactService;

    private final MedicalContactQueryService medicalContactQueryService;

    public MedicalContactResource(MedicalContactService medicalContactService, MedicalContactQueryService medicalContactQueryService) {
        this.medicalContactService = medicalContactService;
    ...
    public ResponseEntity<MedicalContactDTO> createMedicalContact(@Valid @RequestBody MedicalContactDTO medicalContactDTO) throws URISyntaxException {
        ...
        MedicalContactDTO result = medicalContactService.save(medicalContactDTO);
    ...
    public ResponseEntity<MedicalContactDTO> getMedicalContact(@PathVariable Long id) {
        ...
        Optional<MedicalContactDTO> medicalContactDTO = medicalContactService.findOne(id);
    ...
    public ResponseEntity<Void> deleteMedicalContact(@PathVariable Long id) {
        ...
        medicalContactService.delete(id);
