...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.amc.careplanner.domain.Tenant.class.getName());
            ...
            createCache(cm, com.amc.careplanner.domain.CarerClientRelation.class.getName());
            ...
            createCache(cm, com.amc.careplanner.domain.TenantDocument.class.getName());
