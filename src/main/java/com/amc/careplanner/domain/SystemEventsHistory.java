...
public class SystemEventsHistory implements Serializable {
    ...
    public SystemEventsHistory callerEmail(String callerEmail) {
    ...
    public SystemEventsHistory callerId(Long callerId) {
    ...
    public SystemEventsHistory clientId(Long clientId) {
