...
public class MedicalContact implements Serializable {
    ...
    public MedicalContact createdDate(ZonedDateTime createdDate) {
    ...
    public MedicalContact clientId(Long clientId) {
    ...
    public MedicalContact hasExtraData(Boolean hasExtraData) {
