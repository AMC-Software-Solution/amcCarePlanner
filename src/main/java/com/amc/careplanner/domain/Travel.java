...
public class Travel implements Serializable {
    ...
    public Travel travelStatus(TravelStatus travelStatus) {
    ...
    public Travel createdDate(ZonedDateTime createdDate) {
    ...
    public Travel clientId(Long clientId) {
    ...
    public Travel hasExtraData(Boolean hasExtraData) {
