...
public class ServiceUserLocation implements Serializable {
    ...
    public ServiceUserLocation createdDate(ZonedDateTime createdDate) {
    ...
    public ServiceUserLocation clientId(Long clientId) {
    ...
    public ServiceUserLocation hasExtraData(Boolean hasExtraData) {
