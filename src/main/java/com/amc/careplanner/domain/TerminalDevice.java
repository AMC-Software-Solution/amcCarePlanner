...
public class TerminalDevice implements Serializable {
    ...
    public TerminalDevice createdDate(ZonedDateTime createdDate) {
    ...
    public TerminalDevice clientId(Long clientId) {
    ...
    public TerminalDevice hasExtraData(Boolean hasExtraData) {
