...
public class ServiceUserEvent implements Serializable {
    ...
    public ServiceUserEvent createdDate(ZonedDateTime createdDate) {
    ...
    public ServiceUserEvent clientId(Long clientId) {
    ...
    public ServiceUserEvent hasExtraData(Boolean hasExtraData) {
