...
public class Communication implements Serializable {
    ...
    public Communication createdDate(ZonedDateTime createdDate) {
    ...
    public Communication clientId(Long clientId) {
    ...
    public Communication hasExtraData(Boolean hasExtraData) {
