...
public class ServiceUser implements Serializable {
    ...
    public ServiceUser email(String email) {
        this.email = email;
        return this;
    }
    ...
    public ServiceUser createdDate(ZonedDateTime createdDate) {
    ...
    public ServiceUser clientId(Long clientId) {
    ...
    public ServiceUser hasExtraData(Boolean hasExtraData) {
