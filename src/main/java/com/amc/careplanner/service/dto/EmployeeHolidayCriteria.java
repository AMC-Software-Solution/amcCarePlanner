...
public class EmployeeHolidayCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering HolidayStatus
     */
    public static class HolidayStatusFilter extends Filter<HolidayStatus> {

        public HolidayStatusFilter() {
        }

        public HolidayStatusFilter(HolidayStatusFilter filter) {
            super(filter);
        }

        @Override
        public HolidayStatusFilter copy() {
            return new HolidayStatusFilter(this);
        }
    ...
    private HolidayStatusFilter holidayStatus;
    ...
    public EmployeeHolidayCriteria(EmployeeHolidayCriteria other) {
        ...
        this.holidayStatus = other.holidayStatus == null ? null : other.holidayStatus.copy();
    ...
    public HolidayStatusFilter getHolidayStatus() {
        return holidayStatus;
    }

    public void setHolidayStatus(HolidayStatusFilter holidayStatus) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(holidayStatus, that.holidayStatus) &&
    ...
    public String toString() {
        return "EmployeeHolidayCriteria{" +
                ...
                (holidayStatus != null ? "holidayStatus=" + holidayStatus + ", " : "") +
                (note != null ? "note=" + note + ", " : "") +
