...
import com.amc.careplanner.repository.ext.ConsentRepositoryExt;
...
@Service
@Transactional
public class ConsentServiceExt extends ConsentService{

    private final Logger log = LoggerFactory.getLogger(ConsentServiceExt.class);

    private final ConsentRepositoryExt consentRepositoryExt;

    private final ConsentMapper consentMapper;

    public ConsentServiceExt(ConsentRepositoryExt consentRepositoryExt, ConsentMapper consentMapper) {
    	super(consentRepositoryExt,consentMapper);
        this.consentRepositoryExt = consentRepositoryExt;
    ...
    public ConsentDTO save(ConsentDTO consentDTO) {
        ...
        consent = consentRepositoryExt.save(consent);
    ...
    public Page<ConsentDTO> findAll(Pageable pageable) {
        ...
        return consentRepositoryExt.findAll(pageable)
    ...
    public Optional<ConsentDTO> findOne(Long id) {
        ...
        return consentRepositoryExt.findById(id)
            .map(consentMapper::toDto);
    }
    ...
    public void delete(Long id) {
        ...
        consentRepositoryExt.deleteById(id);
    }
}
