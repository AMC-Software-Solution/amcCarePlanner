...
import com.amc.careplanner.repository.ext.EqualityRepositoryExt;
...
@Service
@Transactional
public class EqualityServiceExt extends EqualityService{

    private final Logger log = LoggerFactory.getLogger(EqualityServiceExt.class);

    private final EqualityRepositoryExt equalityRepositoryExt;

    private final EqualityMapper equalityMapper;

    public EqualityServiceExt(EqualityRepositoryExt equalityRepositoryExt, EqualityMapper equalityMapper) {
        super(equalityRepositoryExt,equalityMapper);
    	this.equalityRepositoryExt = equalityRepositoryExt;
    ...
    public EqualityDTO save(EqualityDTO equalityDTO) {
        ...
        equality = equalityRepositoryExt.save(equality);
    ...
    public Page<EqualityDTO> findAll(Pageable pageable) {
        ...
        return equalityRepositoryExt.findAll(pageable)
    ...
    public Optional<EqualityDTO> findOne(Long id) {
        ...
        return equalityRepositoryExt.findById(id)
            .map(equalityMapper::toDto);
    }
    ...
    public void delete(Long id) {
        ...
        equalityRepositoryExt.deleteById(id);
    }
}
