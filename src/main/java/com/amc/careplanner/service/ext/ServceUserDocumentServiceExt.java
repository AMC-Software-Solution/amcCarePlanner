...
import com.amc.careplanner.repository.ext.ServceUserDocumentRepositoryExt;
...
@Service
@Transactional
public class ServceUserDocumentServiceExt extends ServceUserDocumentService{

    private final Logger log = LoggerFactory.getLogger(ServceUserDocumentServiceExt.class);

    private final ServceUserDocumentRepositoryExt servceUserDocumentRepositoryExt;

    private final ServceUserDocumentMapper servceUserDocumentMapper;

    public ServceUserDocumentServiceExt(ServceUserDocumentRepositoryExt servceUserDocumentRepositoryExt, ServceUserDocumentMapper servceUserDocumentMapper) {
        super(servceUserDocumentRepositoryExt,servceUserDocumentMapper);
    	this.servceUserDocumentRepositoryExt = servceUserDocumentRepositoryExt;
    ...
    public ServceUserDocumentDTO save(ServceUserDocumentDTO servceUserDocumentDTO) {
        ...
        servceUserDocument = servceUserDocumentRepositoryExt.save(servceUserDocument);
    ...
    public Page<ServceUserDocumentDTO> findAll(Pageable pageable) {
        ...
        return servceUserDocumentRepositoryExt.findAll(pageable)
    ...
    public Optional<ServceUserDocumentDTO> findOne(Long id) {
        ...
        return servceUserDocumentRepositoryExt.findById(id)
            .map(servceUserDocumentMapper::toDto);
    }
    ...
    public void delete(Long id) {
        ...
        servceUserDocumentRepositoryExt.deleteById(id);
    }
}
