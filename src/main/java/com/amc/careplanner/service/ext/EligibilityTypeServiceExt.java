...
@Service
@Transactional
public class EligibilityTypeServiceExt extends EligibilityTypeService{

    private final Logger log = LoggerFactory.getLogger(EligibilityTypeServiceExt.class);
    ...
    public EligibilityTypeServiceExt(EligibilityTypeRepository eligibilityTypeRepository, EligibilityTypeMapper eligibilityTypeMapper) {
        super(eligibilityTypeRepository,eligibilityTypeMapper);
