...
@Service
@Transactional
public class EmployeeLocationServiceExt extends EmployeeLocationService{

    private final Logger log = LoggerFactory.getLogger(EmployeeLocationServiceExt.class);
    ...
    public EmployeeLocationServiceExt(EmployeeLocationRepository employeeLocationRepository, EmployeeLocationMapper employeeLocationMapper) {
        super(employeeLocationRepository,employeeLocationMapper);
