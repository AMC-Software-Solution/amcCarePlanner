...
import com.amc.careplanner.repository.ext.EmergencyContactRepositoryExt;
...
@Service
@Transactional
public class EmergencyContactServiceExt extends EmergencyContactService{

    private final Logger log = LoggerFactory.getLogger(EmergencyContactServiceExt.class);

    private final EmergencyContactRepositoryExt emergencyContactRepositoryExt;

    private final EmergencyContactMapper emergencyContactMapper;

    public EmergencyContactServiceExt(EmergencyContactRepositoryExt emergencyContactRepositoryExt, EmergencyContactMapper emergencyContactMapper) {
    	super(emergencyContactRepositoryExt,emergencyContactMapper);
        this.emergencyContactRepositoryExt = emergencyContactRepositoryExt;
    ...
    public EmergencyContactDTO save(EmergencyContactDTO emergencyContactDTO) {
        ...
        emergencyContact = emergencyContactRepositoryExt.save(emergencyContact);
    ...
    public Page<EmergencyContactDTO> findAll(Pageable pageable) {
        ...
        return emergencyContactRepositoryExt.findAll(pageable)
    ...
    public Optional<EmergencyContactDTO> findOne(Long id) {
        ...
        return emergencyContactRepositoryExt.findById(id)
            .map(emergencyContactMapper::toDto);
    }
    ...
    public void delete(Long id) {
        ...
        emergencyContactRepositoryExt.deleteById(id);
    }
}
