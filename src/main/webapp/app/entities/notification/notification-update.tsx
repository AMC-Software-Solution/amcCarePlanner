        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : notificationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="notification-createdDate">
                ...
                <AvInput
                  ...
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.notificationEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="notification-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
