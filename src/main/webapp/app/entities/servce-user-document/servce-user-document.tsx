            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('tenantId')}>
                  <Translate contentKey="carePlannerApp.servceUserDocument.tenantId">Tenant Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {servceUserDocumentList.map((servceUserDocument, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{servceUserDocument.documentCode}</td>
                  ...
                  <td>{servceUserDocument.tenantId}</td>
                  <td>
