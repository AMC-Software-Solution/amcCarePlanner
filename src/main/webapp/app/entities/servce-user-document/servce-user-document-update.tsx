        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : servceUserDocumentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="documentCodeLabel" for="servce-user-document-documentCode">
                  <Translate contentKey="carePlannerApp.servceUserDocument.documentCode">Document Code</Translate>
                </Label>
                <AvField
                  id="servce-user-document-documentCode"
                  type="text"
                  name="documentCode"
                  validate={{
                    required: { value: true, errorMessage: translate('entity.validation.required') },
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="servce-user-document-tenantId">
                  <Translate contentKey="carePlannerApp.servceUserDocument.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="servce-user-document-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
