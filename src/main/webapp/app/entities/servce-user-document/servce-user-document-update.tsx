        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : servceUserDocumentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="servce-user-document-createdDate">
                  <Translate contentKey="carePlannerApp.servceUserDocument.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="servce-user-document-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.servceUserDocumentEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="servce-user-document-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
