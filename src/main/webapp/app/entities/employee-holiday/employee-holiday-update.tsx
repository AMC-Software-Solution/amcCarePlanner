        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : employeeHolidayEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="holidayStatusLabel" for="employee-holiday-holidayStatus">
                  <Translate contentKey="carePlannerApp.employeeHoliday.holidayStatus">Holiday Status</Translate>
                </Label>
                <AvInput
                  id="employee-holiday-holidayStatus"
                  type="select"
                  className="form-control"
                  name="holidayStatus"
                  value={(!isNew && employeeHolidayEntity.holidayStatus) || 'REQUESTED'}
                >
                  <option value="REQUESTED">{translate('carePlannerApp.HolidayStatus.REQUESTED')}</option>
                  <option value="APPROVED">{translate('carePlannerApp.HolidayStatus.APPROVED')}</option>
                  <option value="REJECTED">{translate('carePlannerApp.HolidayStatus.REJECTED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="rejectionReasonLabel" for="employee-holiday-rejectionReason">
                  <Translate contentKey="carePlannerApp.employeeHoliday.rejectionReason">Rejection Reason</Translate>
                </Label>
                <AvField id="employee-holiday-rejectionReason" type="text" name="rejectionReason" />
              </AvGroup>
              <AvGroup>
                <Label id="createdDateLabel" for="employee-holiday-createdDate">
                  <Translate contentKey="carePlannerApp.employeeHoliday.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="employee-holiday-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.employeeHolidayEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="employee-holiday-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.employeeHoliday.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
