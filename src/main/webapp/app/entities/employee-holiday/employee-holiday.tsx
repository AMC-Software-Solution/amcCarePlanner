          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('holidayStatus')}>
            ...
            <tbody>
              {employeeHolidayList.map((employeeHoliday, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`carePlannerApp.HolidayStatus.${employeeHoliday.holidayStatus}`} />
                  </td>
                  <td>{employeeHoliday.note}</td>
                  <td>{employeeHoliday.rejectionReason}</td>
                  <td>
                    {employeeHoliday.createdDate ? (
                      <TextFormat type="date" value={employeeHoliday.createdDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                  ...
                  <td>{employeeHoliday.hasExtraData ? 'true' : 'false'}</td>
                  <td>
