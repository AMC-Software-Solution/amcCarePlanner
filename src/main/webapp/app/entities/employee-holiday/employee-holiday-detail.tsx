    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{employeeHolidayEntity.holidayStatus}</dd>
          <dt>
            <span id="note">
          ...
          <dd>{employeeHolidayEntity.rejectionReason}</dd>
          <dt>
            <span id="createdDate">
          ...
          <dd>
            {employeeHolidayEntity.createdDate ? (
              <TextFormat value={employeeHolidayEntity.createdDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
