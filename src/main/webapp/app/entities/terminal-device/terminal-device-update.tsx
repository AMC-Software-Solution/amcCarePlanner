        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : terminalDeviceEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="terminal-device-createdDate">
                  <Translate contentKey="carePlannerApp.terminalDevice.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="terminal-device-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.terminalDeviceEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="terminal-device-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
