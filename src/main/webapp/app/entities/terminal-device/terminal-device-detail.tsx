    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {terminalDeviceEntity.createdDate ? (
              <TextFormat value={terminalDeviceEntity.createdDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dd>{terminalDeviceEntity.hasExtraData ? 'true' : 'false'}</dd>
          <dt>
