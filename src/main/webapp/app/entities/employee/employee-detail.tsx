    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{employeeEntity.employeeBio}</dd>
          <dt>
          ...
          <dd>{employeeEntity.hasExtraData ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="carePlannerApp.employee.user">User</Translate>
          </dt>
          <dd>{employeeEntity.userEmail ? employeeEntity.userEmail : ''}</dd>
          <dt>
            <Translate contentKey="carePlannerApp.employee.designation">Designation</Translate>
          </dt>
          <dd>{employeeEntity.designationDesignation ? employeeEntity.designationDesignation : ''}</dd>
          <dt>
          ...
          <dd>{employeeEntity.branchName ? employeeEntity.branchName : ''}</dd>
        </dl>
