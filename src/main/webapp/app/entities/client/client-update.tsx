            ...
            <AvForm model={isNew ? {} : clientEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="enabledLabel">
                  <AvInput id="client-enabled" type="checkbox" className="form-check-input" name="enabled" />
                  <Translate contentKey="carePlannerApp.client.enabled">Enabled</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
                <Label id="reasonLabel" for="client-reason">
                  <Translate contentKey="carePlannerApp.client.reason">Reason</Translate>
                </Label>
                <AvField id="client-reason" type="text" name="reason" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="client-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.client.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
