        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : documentTypeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="document-type-createdDate">
                  <Translate contentKey="carePlannerApp.documentType.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="document-type-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.documentTypeEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="document-type-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
