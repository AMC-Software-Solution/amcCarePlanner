            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="carePlannerApp.question.createdDate">Created Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('clientId')}>
                  <Translate contentKey="carePlannerApp.question.clientId">Client Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('hasExtraData')}>
                  <Translate contentKey="carePlannerApp.question.hasExtraData">Has Extra Data</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {questionList.map((question, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{question.clientId}</td>
                  <td>{question.hasExtraData ? 'true' : 'false'}</td>
