            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('clientId')}>
                  <Translate contentKey="carePlannerApp.answer.clientId">Client Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('hasExtraData')}>
                  <Translate contentKey="carePlannerApp.answer.hasExtraData">Has Extra Data</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {answerList.map((answer, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{answer.clientId}</td>
                  <td>{answer.hasExtraData ? 'true' : 'false'}</td>
