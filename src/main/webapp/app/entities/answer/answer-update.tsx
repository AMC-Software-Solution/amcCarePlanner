            ...
            <AvForm model={isNew ? {} : answerEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="answer-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.answer.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
