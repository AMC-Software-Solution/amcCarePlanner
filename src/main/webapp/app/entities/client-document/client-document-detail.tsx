    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {clientDocumentEntity.createdDate ? (
              <TextFormat value={clientDocumentEntity.createdDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dd>{clientDocumentEntity.hasExtraData ? 'true' : 'false'}</dd>
          <dt>
