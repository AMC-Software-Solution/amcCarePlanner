            ...
            <AvForm model={isNew ? {} : taskEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="task-createdDate">
                  <Translate contentKey="carePlannerApp.task.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="task-createdDate"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label id="clientIdLabel" for="task-clientId">
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="task-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.task.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
