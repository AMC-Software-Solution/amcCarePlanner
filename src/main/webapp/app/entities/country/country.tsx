  ...
  return (
    <div>
      <h2 id="country-heading">
        <Translate contentKey="carePlannerApp.country.home.title">Countries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="carePlannerApp.country.home.createLabel">Create new Country</Translate>
        </Link>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('countryName')}>
                  <Translate contentKey="carePlannerApp.country.countryName">Country Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('countryIsoCode')}>
                  <Translate contentKey="carePlannerApp.country.countryIsoCode">Country Iso Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('countryFlagUrl')}>
                  <Translate contentKey="carePlannerApp.country.countryFlagUrl">Country Flag Url</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="carePlannerApp.country.createdDate">Created Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('hasExtraData')}>
                  <Translate contentKey="carePlannerApp.country.hasExtraData">Has Extra Data</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {countryList.map((country, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {country.lastUpdatedDate ? <TextFormat type="date" value={country.lastUpdatedDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>{country.hasExtraData ? 'true' : 'false'}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="carePlannerApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
