        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : serviceUserContactEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="emailLabel" for="service-user-contact-email">
                  <Translate contentKey="carePlannerApp.serviceUserContact.email">Email</Translate>
                </Label>
                <AvField id="service-user-contact-email" type="text" name="email" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="service-user-contact-tenantId">
                  <Translate contentKey="carePlannerApp.serviceUserContact.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="service-user-contact-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
