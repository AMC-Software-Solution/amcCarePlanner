    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{eligibilityEntity.isEligible ? 'true' : 'false'}</dd>
          <dt>
            <span id="note">
          ...
          <dd>
            {eligibilityEntity.createdDate ? (
              <TextFormat value={eligibilityEntity.createdDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dd>{eligibilityEntity.hasExtraData ? 'true' : 'false'}</dd>
          <dt>
