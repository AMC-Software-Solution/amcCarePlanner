        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : eligibilityEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="isEligibleLabel">
                  <AvInput id="eligibility-isEligible" type="checkbox" className="form-check-input" name="isEligible" />
                  <Translate contentKey="carePlannerApp.eligibility.isEligible">Is Eligible</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="eligibility-createdDate">
                  <Translate contentKey="carePlannerApp.eligibility.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="eligibility-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.eligibilityEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="eligibility-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.eligibility.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
