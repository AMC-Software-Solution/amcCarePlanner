    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="createdDate">
              <Translate contentKey="carePlannerApp.serviceUser.createdDate">Created Date</Translate>
            </span>
          </dt>
          <dd>
            {serviceUserEntity.createdDate ? (
              <TextFormat value={serviceUserEntity.createdDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dd>{serviceUserEntity.clientId}</dd>
          <dt>
            <span id="hasExtraData">
              <Translate contentKey="carePlannerApp.serviceUser.hasExtraData">Has Extra Data</Translate>
            </span>
          </dt>
          <dd>{serviceUserEntity.hasExtraData ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="carePlannerApp.serviceUser.user">User</Translate>
          </dt>
          <dd>{serviceUserEntity.userEmail ? serviceUserEntity.userEmail : ''}</dd>
          <dt>
