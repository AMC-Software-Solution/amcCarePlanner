        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : serviceUserEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="service-user-createdDate">
                  <Translate contentKey="carePlannerApp.serviceUser.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="service-user-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.serviceUserEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="service-user-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
