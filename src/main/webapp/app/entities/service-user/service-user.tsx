            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="carePlannerApp.serviceUser.createdDate">Created Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('hasExtraData')}>
                  <Translate contentKey="carePlannerApp.serviceUser.hasExtraData">Has Extra Data</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {serviceUserList.map((serviceUser, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {serviceUser.createdDate ? <TextFormat type="date" value={serviceUser.createdDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                  ...
                  <td>{serviceUser.hasExtraData ? 'true' : 'false'}</td>
                  <td>{serviceUser.userEmail ? serviceUser.userEmail : ''}</td>
