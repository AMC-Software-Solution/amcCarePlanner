    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{travelEntity.createdDate ? <TextFormat value={travelEntity.createdDate} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
          ...
          <dd>{travelEntity.hasExtraData ? 'true' : 'false'}</dd>
          <dt>
