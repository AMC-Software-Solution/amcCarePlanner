            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="carePlannerApp.timesheet.createdDate">Created Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('clientId')}>
                  <Translate contentKey="carePlannerApp.timesheet.clientId">Client Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('hasExtraData')}>
                  <Translate contentKey="carePlannerApp.timesheet.hasExtraData">Has Extra Data</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="carePlannerApp.timesheet.task">Task</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {timesheetList.map((timesheet, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {timesheet.createdDate ? <TextFormat type="date" value={timesheet.createdDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                  ...
                  <td>{timesheet.clientId}</td>
                  <td>{timesheet.hasExtraData ? 'true' : 'false'}</td>
                  <td>{timesheet.taskTaskName ? <Link to={`task/${timesheet.taskId}`}>{timesheet.taskTaskName}</Link> : ''}</td>
                  <td>
