            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="carePlannerApp.consent.createdDate">Created Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('clientId')}>
                  <Translate contentKey="carePlannerApp.consent.clientId">Client Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('hasExtraData')}>
                  <Translate contentKey="carePlannerApp.consent.hasExtraData">Has Extra Data</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {consentList.map((consent, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{consent.createdDate ? <TextFormat type="date" value={consent.createdDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
                  ...
                  <td>{consent.hasExtraData ? 'true' : 'false'}</td>
                  <td>
