        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : consentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="consent-createdDate">
                  <Translate contentKey="carePlannerApp.consent.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="consent-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.consentEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="clientIdLabel" for="consent-clientId">
                  <Translate contentKey="carePlannerApp.consent.clientId">Client Id</Translate>
                </Label>
                <AvField
                  id="consent-clientId"
                  type="string"
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="consent-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.consent.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
