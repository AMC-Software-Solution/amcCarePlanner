        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : powerOfAttorneyEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="power-of-attorney-tenantId">
                  <Translate contentKey="carePlannerApp.powerOfAttorney.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="power-of-attorney-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
