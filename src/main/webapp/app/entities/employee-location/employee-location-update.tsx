        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : employeeLocationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="employee-location-tenantId">
                  <Translate contentKey="carePlannerApp.employeeLocation.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="employee-location-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
