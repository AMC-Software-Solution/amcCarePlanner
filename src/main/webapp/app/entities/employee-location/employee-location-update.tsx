        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : employeeLocationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="employee-location-createdDate">
                  <Translate contentKey="carePlannerApp.employeeLocation.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="employee-location-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.employeeLocationEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="employee-location-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
