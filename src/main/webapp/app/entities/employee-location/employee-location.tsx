            ...
            <tbody>
              {employeeLocationList.map((employeeLocation, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {employeeLocation.createdDate ? (
                      <TextFormat type="date" value={employeeLocation.createdDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                  ...
                  <td>{employeeLocation.hasExtraData ? 'true' : 'false'}</td>
                  <td>
