            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('tenantId')}>
                  <Translate contentKey="carePlannerApp.employeeDocument.tenantId">Tenant Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {employeeDocumentList.map((employeeDocument, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{employeeDocument.documentCode}</td>
                  ...
                  <td>{employeeDocument.tenantId}</td>
                  <td>
