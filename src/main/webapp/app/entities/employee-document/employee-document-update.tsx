        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : employeeDocumentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="documentCodeLabel" for="employee-document-documentCode">
                  <Translate contentKey="carePlannerApp.employeeDocument.documentCode">Document Code</Translate>
                </Label>
                <AvField
                  id="employee-document-documentCode"
                  type="text"
                  name="documentCode"
                  validate={{
                    required: { value: true, errorMessage: translate('entity.validation.required') },
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="employee-document-tenantId">
                  <Translate contentKey="carePlannerApp.employeeDocument.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="employee-document-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
