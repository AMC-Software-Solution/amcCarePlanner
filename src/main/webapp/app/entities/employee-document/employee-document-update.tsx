        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : employeeDocumentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="employee-document-createdDate">
                  <Translate contentKey="carePlannerApp.employeeDocument.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="employee-document-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.employeeDocumentEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="employee-document-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
