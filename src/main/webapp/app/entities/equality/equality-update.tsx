        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : equalityEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="equality-createdDate">
                  <Translate contentKey="carePlannerApp.equality.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="equality-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.equalityEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="equality-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
