            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('clientId')}>
                  <Translate contentKey="carePlannerApp.serviceUserLocation.clientId">Client Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {serviceUserLocationList.map((serviceUserLocation, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {serviceUserLocation.createdDate ? (
                      <TextFormat type="date" value={serviceUserLocation.createdDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                  ...
                  <td>{serviceUserLocation.clientId}</td>
                  <td>{serviceUserLocation.hasExtraData ? 'true' : 'false'}</td>
                  <td>
