        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : serviceUserLocationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="service-user-location-tenantId">
                  <Translate contentKey="carePlannerApp.serviceUserLocation.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="service-user-location-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
