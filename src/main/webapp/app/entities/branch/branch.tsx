          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="carePlannerApp.branch.tenant">Tenant</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {branchList.map((branch, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{branch.tenantTenantName ? <Link to={`tenant/${branch.tenantId}`}>{branch.tenantTenantName}</Link> : ''}</td>
