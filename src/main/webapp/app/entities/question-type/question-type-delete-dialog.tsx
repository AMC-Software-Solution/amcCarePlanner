...
export const QuestionTypeDeleteDialog = (props: IQuestionTypeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="carePlannerApp.questionType.delete.question">
        <Translate contentKey="carePlannerApp.questionType.delete.question" interpolate={{ id: questionTypeEntity.id }}>
