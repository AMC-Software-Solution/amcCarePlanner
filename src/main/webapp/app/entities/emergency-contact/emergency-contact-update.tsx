        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : emergencyContactEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="emergency-contact-tenantId">
                  <Translate contentKey="carePlannerApp.emergencyContact.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="emergency-contact-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
