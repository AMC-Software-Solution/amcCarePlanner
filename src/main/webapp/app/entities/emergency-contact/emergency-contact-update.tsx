        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : emergencyContactEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="emergency-contact-createdDate">
                  <Translate contentKey="carePlannerApp.emergencyContact.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="emergency-contact-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.emergencyContactEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="emergency-contact-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
