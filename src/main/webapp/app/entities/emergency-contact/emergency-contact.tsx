            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('clientId')}>
                  <Translate contentKey="carePlannerApp.emergencyContact.clientId">Client Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {emergencyContactList.map((emergencyContact, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {emergencyContact.createdDate ? (
                      <TextFormat type="date" value={emergencyContact.createdDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                  ...
                  <td>{emergencyContact.clientId}</td>
                  <td>{emergencyContact.hasExtraData ? 'true' : 'false'}</td>
                  <td>
