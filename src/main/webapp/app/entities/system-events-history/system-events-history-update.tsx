        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : systemEventsHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="system-events-history-tenantId">
                  <Translate contentKey="carePlannerApp.systemEventsHistory.tenantId">Tenant Id</Translate>
                </Label>
                <AvField id="system-events-history-tenantId" type="string" className="form-control" name="tenantId" />
              </AvGroup>
              <AvGroup>
