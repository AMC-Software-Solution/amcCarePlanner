        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : systemEventsHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="callerEmailLabel" for="system-events-history-callerEmail">
                  <Translate contentKey="carePlannerApp.systemEventsHistory.callerEmail">Caller Email</Translate>
                </Label>
                <AvField id="system-events-history-callerEmail" type="text" name="callerEmail" />
              </AvGroup>
              <AvGroup>
                <Label id="callerIdLabel" for="system-events-history-callerId">
                  <Translate contentKey="carePlannerApp.systemEventsHistory.callerId">Caller Id</Translate>
                </Label>
                <AvField id="system-events-history-callerId" type="string" className="form-control" name="callerId" />
              </AvGroup>
              <AvGroup>
