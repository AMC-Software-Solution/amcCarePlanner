          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('callerEmail')}>
                  <Translate contentKey="carePlannerApp.systemEventsHistory.callerEmail">Caller Email</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('callerId')}>
                  <Translate contentKey="carePlannerApp.systemEventsHistory.callerId">Caller Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {systemEventsHistoryList.map((systemEventsHistory, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{systemEventsHistory.callerEmail}</td>
                  <td>{systemEventsHistory.callerId}</td>
                  <td>{systemEventsHistory.clientId}</td>
                  <td>{systemEventsHistory.triggedByEmail ? systemEventsHistory.triggedByEmail : ''}</td>
