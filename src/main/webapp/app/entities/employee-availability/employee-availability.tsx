            ...
            <tbody>
              {employeeAvailabilityList.map((employeeAvailability, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{employeeAvailability.isAvailableForWorkWeekDays ? 'true' : 'false'}</td>
                  <td>{employeeAvailability.minimumHoursPerWeekWeekDays}</td>
                  <td>{employeeAvailability.maximumHoursPerWeekWeekDays}</td>
                  <td>{employeeAvailability.isAvailableForWorkWeekEnds ? 'true' : 'false'}</td>
                  <td>{employeeAvailability.minimumHoursPerWeekWeekEnds}</td>
                  <td>{employeeAvailability.maximumHoursPerWeekWeekEnds}</td>
                  <td>
