        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : medicalContactEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="medical-contact-createdDate">
                  <Translate contentKey="carePlannerApp.medicalContact.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="medical-contact-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.medicalContactEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="clientIdLabel" for="medical-contact-clientId">
                  <Translate contentKey="carePlannerApp.medicalContact.clientId">Client Id</Translate>
                </Label>
                <AvField
                  id="medical-contact-clientId"
                  type="string"
                  className="form-control"
                  name="clientId"
                  validate={{
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="medical-contact-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
