        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : systemSettingEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="system-setting-tenantId">
                  <Translate contentKey="carePlannerApp.systemSetting.tenantId">Tenant Id</Translate>
                </Label>
                <AvField id="system-setting-tenantId" type="string" className="form-control" name="tenantId" />
              </AvGroup>
