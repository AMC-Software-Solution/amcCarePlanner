            ...
            <tbody>
              {serviceUserEventList.map((serviceUserEvent, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {serviceUserEvent.createdDate ? (
                      <TextFormat type="date" value={serviceUserEvent.createdDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                  ...
                  <td>{serviceUserEvent.hasExtraData ? 'true' : 'false'}</td>
                  <td>
