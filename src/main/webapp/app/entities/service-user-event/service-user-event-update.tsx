        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : serviceUserEventEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="service-user-event-createdDate">
                  <Translate contentKey="carePlannerApp.serviceUserEvent.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="service-user-event-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.serviceUserEventEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="service-user-event-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.serviceUserEvent.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
