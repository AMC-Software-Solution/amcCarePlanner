            ...
            <AvForm model={isNew ? {} : serviceUserEventEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  ...
                  <option value="COMPLAINT">{translate('carePlannerApp.ServiceUserEventType.COMPLAINT')}</option>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="service-user-event-tenantId">
                  <Translate contentKey="carePlannerApp.serviceUserEvent.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="service-user-event-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
