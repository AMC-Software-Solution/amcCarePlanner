            ...
            <AvForm model={isNew ? {} : invoiceEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="invoice-createdDate">
                  <Translate contentKey="carePlannerApp.invoice.createdDate">Created Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="clientIdLabel" for="invoice-clientId">
                  <Translate contentKey="carePlannerApp.invoice.clientId">Client Id</Translate>
                </Label>
                <AvField
                  id="invoice-clientId"
                  type="string"
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="invoice-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.invoice.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
