            ...
            <AvForm model={isNew ? {} : disabilityEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="isDisabledLabel">
                  <AvInput id="disability-isDisabled" type="checkbox" className="form-check-input" name="isDisabled" />
                  <Translate contentKey="carePlannerApp.disability.isDisabled">Is Disabled</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="disability-createdDate">
                  <Translate contentKey="carePlannerApp.disability.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="disability-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.disabilityEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="disability-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
                  <Translate contentKey="carePlannerApp.disability.hasExtraData">Has Extra Data</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
