    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{disabilityEntity.isDisabled ? 'true' : 'false'}</dd>
          <dt>
            <span id="note">
          ...
          <dd>
            {disabilityEntity.createdDate ? <TextFormat value={disabilityEntity.createdDate} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>
          ...
          <dd>{disabilityEntity.hasExtraData ? 'true' : 'false'}</dd>
          <dt>
