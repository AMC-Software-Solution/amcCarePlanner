        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : communicationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="tenantIdLabel" for="communication-tenantId">
                  <Translate contentKey="carePlannerApp.communication.tenantId">Tenant Id</Translate>
                </Label>
                <AvField
                  id="communication-tenantId"
                  type="string"
                  className="form-control"
                  name="tenantId"
                  validate={{
