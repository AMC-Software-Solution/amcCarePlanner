        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : communicationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="communication-createdDate">
                  <Translate contentKey="carePlannerApp.communication.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="communication-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.communicationEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="communication-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
