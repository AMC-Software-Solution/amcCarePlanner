        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : serviceOrderEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="createdDateLabel" for="service-order-createdDate">
                  <Translate contentKey="carePlannerApp.serviceOrder.createdDate">Created Date</Translate>
                </Label>
                <AvInput
                  id="service-order-createdDate"
                  type="datetime-local"
                  className="form-control"
                  name="createdDate"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? displayDefaultDateTime() : convertDateTimeFromServer(props.serviceOrderEntity.createdDate)}
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="hasExtraDataLabel">
                  <AvInput id="service-order-hasExtraData" type="checkbox" className="form-check-input" name="hasExtraData" />
