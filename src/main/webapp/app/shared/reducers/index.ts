...
// prettier-ignore
import carerClientRelation, {
  CarerClientRelationState
...
export interface IRootState {
  ...
  readonly carerClientRelation: CarerClientRelationState;
  ...
  readonly tenantDocument: TenantDocumentState;
