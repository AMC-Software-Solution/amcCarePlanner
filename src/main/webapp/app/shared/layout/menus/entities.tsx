...
export const EntitiesMenu = props => (
  ...
  >
    ...
    <MenuItem icon="asterisk" to="/carer-client-relation">
      <Translate contentKey="global.menu.entities.carerClientRelation" />
    </MenuItem>
    ...
    <MenuItem icon="asterisk" to="/tenant-document">
      <Translate contentKey="global.menu.entities.tenantDocument" />
    </MenuItem>
