...
export default class ServiceOrderUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#service-order-createdDate'));
  lastUpdatedDateInput: ElementFinder = element(by.css('input#service-order-lastUpdatedDate'));
  hasExtraDataInput: ElementFinder = element(by.css('input#service-order-hasExtraData'));
