...
export default class TerminalDeviceUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#terminal-device-createdDate'));
  ...
  hasExtraDataInput: ElementFinder = element(by.css('input#terminal-device-hasExtraData'));
