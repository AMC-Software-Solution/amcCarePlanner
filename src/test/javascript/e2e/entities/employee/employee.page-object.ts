...
export class EmployeeDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('carePlannerApp.employee.delete.question'));
...
export default class EmployeeComponentsPage {
  ...
  async deleteEmployee() {
    ...
    expect(await employeeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/carePlannerApp.employee.delete.question/);
