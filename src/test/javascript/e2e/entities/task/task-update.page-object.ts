...
export default class TaskUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#task-createdDate'));
  lastUpdatedDateInput: ElementFinder = element(by.css('input#task-lastUpdatedDate'));
  clientIdInput: ElementFinder = element(by.css('input#task-clientId'));
  hasExtraDataInput: ElementFinder = element(by.css('input#task-hasExtraData'));
