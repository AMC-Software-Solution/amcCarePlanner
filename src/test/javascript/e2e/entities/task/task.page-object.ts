...
export class TaskDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('carePlannerApp.task.delete.question'));
...
export default class TaskComponentsPage {
  ...
  async deleteTask() {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/carePlannerApp.task.delete.question/);
