...
export default class EmployeeDocumentUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#employee-document-createdDate'));
  lastUpdatedDateInput: ElementFinder = element(by.css('input#employee-document-lastUpdatedDate'));
  clientIdInput: ElementFinder = element(by.css('input#employee-document-clientId'));
  hasExtraDataInput: ElementFinder = element(by.css('input#employee-document-hasExtraData'));
