...
export default class ClientDocumentUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#client-document-createdDate'));
  ...
  hasExtraDataInput: ElementFinder = element(by.css('input#client-document-hasExtraData'));
