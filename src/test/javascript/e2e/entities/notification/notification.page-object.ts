...
export class NotificationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('carePlannerApp.notification.delete.question'));
...
export default class NotificationComponentsPage {
  ...
  async deleteNotification() {
    ...
    expect(await notificationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/carePlannerApp.notification.delete.question/);
