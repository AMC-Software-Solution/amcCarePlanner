...
export default class ServiceUserContactUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#service-user-contact-createdDate'));
  ...
  hasExtraDataInput: ElementFinder = element(by.css('input#service-user-contact-hasExtraData'));
