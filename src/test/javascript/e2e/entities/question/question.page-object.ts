...
export class QuestionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('carePlannerApp.question.delete.question'));
...
export default class QuestionComponentsPage {
  ...
  async deleteQuestion() {
    ...
    expect(await questionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/carePlannerApp.question.delete.question/);
