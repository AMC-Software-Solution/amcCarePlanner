...
export default class ServceUserDocumentUpdatePage {
  ...
  documentCodeInput: ElementFinder = element(by.css('input#servce-user-document-documentCode'));
  ...
  tenantIdInput: ElementFinder = element(by.css('input#servce-user-document-tenantId'));
