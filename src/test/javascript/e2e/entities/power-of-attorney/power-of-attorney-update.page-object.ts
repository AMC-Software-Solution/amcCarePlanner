...
export default class PowerOfAttorneyUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#power-of-attorney-createdDate'));
  ...
  hasExtraDataInput: ElementFinder = element(by.css('input#power-of-attorney-hasExtraData'));
