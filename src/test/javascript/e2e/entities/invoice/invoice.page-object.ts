...
export class InvoiceDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('carePlannerApp.invoice.delete.question'));
...
export default class InvoiceComponentsPage {
  ...
  async deleteInvoice() {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/carePlannerApp.invoice.delete.question/);
