...
export default class ServiceUserEventUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#service-user-event-createdDate'));
  ...
  hasExtraDataInput: ElementFinder = element(by.css('input#service-user-event-hasExtraData'));
