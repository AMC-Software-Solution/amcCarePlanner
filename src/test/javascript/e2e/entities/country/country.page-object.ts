...
export class CountryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('carePlannerApp.country.delete.question'));
...
export default class CountryComponentsPage {
  ...
  async deleteCountry() {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/carePlannerApp.country.delete.question/);
