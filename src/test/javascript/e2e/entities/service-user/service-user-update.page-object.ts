...
export default class ServiceUserUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#service-user-createdDate'));
  ...
  hasExtraDataInput: ElementFinder = element(by.css('input#service-user-hasExtraData'));
