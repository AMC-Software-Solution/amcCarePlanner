...
export default class ServiceUserLocationUpdatePage {
  pageTitle: ElementFinder = element(by.id('carePlannerApp.serviceUserLocation.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  latitudeInput: ElementFinder = element(by.css('input#service-user-location-latitude'));
  longitudeInput: ElementFinder = element(by.css('input#service-user-location-longitude'));
  createdDateInput: ElementFinder = element(by.css('input#service-user-location-createdDate'));
  lastUpdatedDateInput: ElementFinder = element(by.css('input#service-user-location-lastUpdatedDate'));
  clientIdInput: ElementFinder = element(by.css('input#service-user-location-clientId'));
  hasExtraDataInput: ElementFinder = element(by.css('input#service-user-location-hasExtraData'));
  employeeSelect: ElementFinder = element(by.css('select#service-user-location-employee'));
