...
export default class MedicalContactUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#medical-contact-createdDate'));
  ...
  hasExtraDataInput: ElementFinder = element(by.css('input#medical-contact-hasExtraData'));
