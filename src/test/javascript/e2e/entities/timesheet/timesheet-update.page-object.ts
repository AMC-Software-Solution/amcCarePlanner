...
export default class TimesheetUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#timesheet-createdDate'));
  ...
  hasExtraDataInput: ElementFinder = element(by.css('input#timesheet-hasExtraData'));
  taskSelect: ElementFinder = element(by.css('select#timesheet-task'));
