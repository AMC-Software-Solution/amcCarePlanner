...
export class ClientDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('carePlannerApp.client.delete.question'));
...
export default class ClientComponentsPage {
  ...
  async deleteClient() {
    ...
    expect(await clientDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/carePlannerApp.client.delete.question/);
