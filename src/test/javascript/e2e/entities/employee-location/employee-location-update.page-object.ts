...
export default class EmployeeLocationUpdatePage {
  ...
  createdDateInput: ElementFinder = element(by.css('input#employee-location-createdDate'));
  lastUpdatedDateInput: ElementFinder = element(by.css('input#employee-location-lastUpdatedDate'));
  clientIdInput: ElementFinder = element(by.css('input#employee-location-clientId'));
  hasExtraDataInput: ElementFinder = element(by.css('input#employee-location-hasExtraData'));
