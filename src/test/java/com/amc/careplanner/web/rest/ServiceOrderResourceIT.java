...
public class ServiceOrderResourceIT {
    ...
    public void createServiceOrder() throws Exception {
        ...
        assertThat(testServiceOrder.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testServiceOrder.getLastUpdatedDate()).isEqualTo(DEFAULT_LAST_UPDATED_DATE);
        assertThat(testServiceOrder.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceOrdersByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where createdDate equals to DEFAULT_CREATED_DATE
        defaultServiceOrderShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the serviceOrderList where createdDate equals to UPDATED_CREATED_DATE
        defaultServiceOrderShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultServiceOrderShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the serviceOrderList where createdDate not equals to UPDATED_CREATED_DATE
        defaultServiceOrderShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where createdDate in DEFAULT_CREATED_DATE or UPDATED_CREATED_DATE
        defaultServiceOrderShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the serviceOrderList where createdDate equals to UPDATED_CREATED_DATE
        defaultServiceOrderShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where createdDate is not null
        defaultServiceOrderShouldBeFound("createdDate.specified=true");

        // Get all the serviceOrderList where createdDate is null
        defaultServiceOrderShouldNotBeFound("createdDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultServiceOrderShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the serviceOrderList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultServiceOrderShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultServiceOrderShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the serviceOrderList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultServiceOrderShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where createdDate is less than DEFAULT_CREATED_DATE
        defaultServiceOrderShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the serviceOrderList where createdDate is less than UPDATED_CREATED_DATE
        defaultServiceOrderShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultServiceOrderShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the serviceOrderList where createdDate is greater than SMALLER_CREATED_DATE
        defaultServiceOrderShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceOrdersByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultServiceOrderShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the serviceOrderList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceOrderShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultServiceOrderShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the serviceOrderList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceOrderShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultServiceOrderShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the serviceOrderList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceOrderShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceOrdersByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceOrderRepository.saveAndFlush(serviceOrder);

        // Get all the serviceOrderList where hasExtraData is not null
        defaultServiceOrderShouldBeFound("hasExtraData.specified=true");

        // Get all the serviceOrderList where hasExtraData is null
        defaultServiceOrderShouldNotBeFound("hasExtraData.specified=false");
    }
    ...
    public void updateServiceOrder() throws Exception {
        ...
        assertThat(testServiceOrder.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testServiceOrder.getLastUpdatedDate()).isEqualTo(UPDATED_LAST_UPDATED_DATE);
        assertThat(testServiceOrder.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
