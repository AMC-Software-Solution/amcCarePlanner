...
public class ServiceUserEventResourceIT {
    ...
    public void createServiceUserEvent() throws Exception {
        ...
        assertThat(testServiceUserEvent.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testServiceUserEvent.getLastUpdatedDate()).isEqualTo(DEFAULT_LAST_UPDATED_DATE);
        assertThat(testServiceUserEvent.getClientId()).isEqualTo(DEFAULT_CLIENT_ID);
        assertThat(testServiceUserEvent.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    public void checkClientIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = serviceUserEventRepository.findAll().size();
        // set the field null
        serviceUserEvent.setClientId(null);
    ...
    @Test
    @Transactional
    public void getAllServiceUserEventsByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where createdDate equals to DEFAULT_CREATED_DATE
        defaultServiceUserEventShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserEventList where createdDate equals to UPDATED_CREATED_DATE
        defaultServiceUserEventShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultServiceUserEventShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserEventList where createdDate not equals to UPDATED_CREATED_DATE
        defaultServiceUserEventShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where createdDate in DEFAULT_CREATED_DATE or UPDATED_CREATED_DATE
        defaultServiceUserEventShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the serviceUserEventList where createdDate equals to UPDATED_CREATED_DATE
        defaultServiceUserEventShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where createdDate is not null
        defaultServiceUserEventShouldBeFound("createdDate.specified=true");

        // Get all the serviceUserEventList where createdDate is null
        defaultServiceUserEventShouldNotBeFound("createdDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultServiceUserEventShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserEventList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultServiceUserEventShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultServiceUserEventShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserEventList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultServiceUserEventShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where createdDate is less than DEFAULT_CREATED_DATE
        defaultServiceUserEventShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserEventList where createdDate is less than UPDATED_CREATED_DATE
        defaultServiceUserEventShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultServiceUserEventShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserEventList where createdDate is greater than SMALLER_CREATED_DATE
        defaultServiceUserEventShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceUserEventsByClientIdIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where clientId equals to DEFAULT_CLIENT_ID
        defaultServiceUserEventShouldBeFound("clientId.equals=" + DEFAULT_CLIENT_ID);

        // Get all the serviceUserEventList where clientId equals to UPDATED_CLIENT_ID
        defaultServiceUserEventShouldNotBeFound("clientId.equals=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByClientIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where clientId not equals to DEFAULT_CLIENT_ID
        defaultServiceUserEventShouldNotBeFound("clientId.notEquals=" + DEFAULT_CLIENT_ID);

        // Get all the serviceUserEventList where clientId not equals to UPDATED_CLIENT_ID
        defaultServiceUserEventShouldBeFound("clientId.notEquals=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByClientIdIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where clientId in DEFAULT_CLIENT_ID or UPDATED_CLIENT_ID
        defaultServiceUserEventShouldBeFound("clientId.in=" + DEFAULT_CLIENT_ID + "," + UPDATED_CLIENT_ID);

        // Get all the serviceUserEventList where clientId equals to UPDATED_CLIENT_ID
        defaultServiceUserEventShouldNotBeFound("clientId.in=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByClientIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where clientId is not null
        defaultServiceUserEventShouldBeFound("clientId.specified=true");

        // Get all the serviceUserEventList where clientId is null
        defaultServiceUserEventShouldNotBeFound("clientId.specified=false");
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByClientIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where clientId is greater than or equal to DEFAULT_CLIENT_ID
        defaultServiceUserEventShouldBeFound("clientId.greaterThanOrEqual=" + DEFAULT_CLIENT_ID);

        // Get all the serviceUserEventList where clientId is greater than or equal to UPDATED_CLIENT_ID
        defaultServiceUserEventShouldNotBeFound("clientId.greaterThanOrEqual=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByClientIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where clientId is less than or equal to DEFAULT_CLIENT_ID
        defaultServiceUserEventShouldBeFound("clientId.lessThanOrEqual=" + DEFAULT_CLIENT_ID);

        // Get all the serviceUserEventList where clientId is less than or equal to SMALLER_CLIENT_ID
        defaultServiceUserEventShouldNotBeFound("clientId.lessThanOrEqual=" + SMALLER_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByClientIdIsLessThanSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where clientId is less than DEFAULT_CLIENT_ID
        defaultServiceUserEventShouldNotBeFound("clientId.lessThan=" + DEFAULT_CLIENT_ID);

        // Get all the serviceUserEventList where clientId is less than UPDATED_CLIENT_ID
        defaultServiceUserEventShouldBeFound("clientId.lessThan=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByClientIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where clientId is greater than DEFAULT_CLIENT_ID
        defaultServiceUserEventShouldNotBeFound("clientId.greaterThan=" + DEFAULT_CLIENT_ID);

        // Get all the serviceUserEventList where clientId is greater than SMALLER_CLIENT_ID
        defaultServiceUserEventShouldBeFound("clientId.greaterThan=" + SMALLER_CLIENT_ID);
    }


    @Test
    @Transactional
    public void getAllServiceUserEventsByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultServiceUserEventShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the serviceUserEventList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserEventShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultServiceUserEventShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the serviceUserEventList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserEventShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultServiceUserEventShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the serviceUserEventList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserEventShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUserEventsByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserEventRepository.saveAndFlush(serviceUserEvent);

        // Get all the serviceUserEventList where hasExtraData is not null
        defaultServiceUserEventShouldBeFound("hasExtraData.specified=true");

        // Get all the serviceUserEventList where hasExtraData is null
        defaultServiceUserEventShouldNotBeFound("hasExtraData.specified=false");
    }
    ...
    public void updateServiceUserEvent() throws Exception {
        ...
        assertThat(testServiceUserEvent.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testServiceUserEvent.getLastUpdatedDate()).isEqualTo(UPDATED_LAST_UPDATED_DATE);
        assertThat(testServiceUserEvent.getClientId()).isEqualTo(UPDATED_CLIENT_ID);
        assertThat(testServiceUserEvent.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
