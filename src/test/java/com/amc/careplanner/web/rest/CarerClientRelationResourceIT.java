...
public class CarerClientRelationResourceIT {
    ...
    public void createCarerClientRelation() throws Exception {
        ...
        assertThat(testCarerClientRelation.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    public void checkTenantIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = carerClientRelationRepository.findAll().size();
        // set the field null
        carerClientRelation.setTenantId(null);
    ...
    @Test
    @Transactional
    public void getAllCarerClientRelationsByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        carerClientRelationRepository.saveAndFlush(carerClientRelation);

        // Get all the carerClientRelationList where tenantId equals to DEFAULT_TENANT_ID
        defaultCarerClientRelationShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the carerClientRelationList where tenantId equals to UPDATED_TENANT_ID
        defaultCarerClientRelationShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllCarerClientRelationsByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        carerClientRelationRepository.saveAndFlush(carerClientRelation);

        // Get all the carerClientRelationList where tenantId not equals to DEFAULT_TENANT_ID
        defaultCarerClientRelationShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the carerClientRelationList where tenantId not equals to UPDATED_TENANT_ID
        defaultCarerClientRelationShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllCarerClientRelationsByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        carerClientRelationRepository.saveAndFlush(carerClientRelation);

        // Get all the carerClientRelationList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultCarerClientRelationShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the carerClientRelationList where tenantId equals to UPDATED_TENANT_ID
        defaultCarerClientRelationShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllCarerClientRelationsByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        carerClientRelationRepository.saveAndFlush(carerClientRelation);

        // Get all the carerClientRelationList where tenantId is not null
        defaultCarerClientRelationShouldBeFound("tenantId.specified=true");

        // Get all the carerClientRelationList where tenantId is null
        defaultCarerClientRelationShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllCarerClientRelationsByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        carerClientRelationRepository.saveAndFlush(carerClientRelation);

        // Get all the carerClientRelationList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultCarerClientRelationShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the carerClientRelationList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultCarerClientRelationShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllCarerClientRelationsByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        carerClientRelationRepository.saveAndFlush(carerClientRelation);

        // Get all the carerClientRelationList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultCarerClientRelationShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the carerClientRelationList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultCarerClientRelationShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllCarerClientRelationsByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        carerClientRelationRepository.saveAndFlush(carerClientRelation);

        // Get all the carerClientRelationList where tenantId is less than DEFAULT_TENANT_ID
        defaultCarerClientRelationShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the carerClientRelationList where tenantId is less than UPDATED_TENANT_ID
        defaultCarerClientRelationShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllCarerClientRelationsByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        carerClientRelationRepository.saveAndFlush(carerClientRelation);

        // Get all the carerClientRelationList where tenantId is greater than DEFAULT_TENANT_ID
        defaultCarerClientRelationShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the carerClientRelationList where tenantId is greater than SMALLER_TENANT_ID
        defaultCarerClientRelationShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateCarerClientRelation() throws Exception {
        ...
        assertThat(testCarerClientRelation.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
