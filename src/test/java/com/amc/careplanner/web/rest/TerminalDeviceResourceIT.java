...
public class TerminalDeviceResourceIT {
    ...
    public void createTerminalDevice() throws Exception {
        ...
        assertThat(testTerminalDevice.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        ...
        assertThat(testTerminalDevice.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    @Test
    @Transactional
    public void getAllTerminalDevicesByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where createdDate equals to DEFAULT_CREATED_DATE
        defaultTerminalDeviceShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the terminalDeviceList where createdDate equals to UPDATED_CREATED_DATE
        defaultTerminalDeviceShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultTerminalDeviceShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the terminalDeviceList where createdDate not equals to UPDATED_CREATED_DATE
        defaultTerminalDeviceShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where createdDate in DEFAULT_CREATED_DATE or UPDATED_CREATED_DATE
        defaultTerminalDeviceShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the terminalDeviceList where createdDate equals to UPDATED_CREATED_DATE
        defaultTerminalDeviceShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where createdDate is not null
        defaultTerminalDeviceShouldBeFound("createdDate.specified=true");

        // Get all the terminalDeviceList where createdDate is null
        defaultTerminalDeviceShouldNotBeFound("createdDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultTerminalDeviceShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the terminalDeviceList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultTerminalDeviceShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultTerminalDeviceShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the terminalDeviceList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultTerminalDeviceShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where createdDate is less than DEFAULT_CREATED_DATE
        defaultTerminalDeviceShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the terminalDeviceList where createdDate is less than UPDATED_CREATED_DATE
        defaultTerminalDeviceShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultTerminalDeviceShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the terminalDeviceList where createdDate is greater than SMALLER_CREATED_DATE
        defaultTerminalDeviceShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllTerminalDevicesByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultTerminalDeviceShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the terminalDeviceList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultTerminalDeviceShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultTerminalDeviceShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the terminalDeviceList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultTerminalDeviceShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultTerminalDeviceShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the terminalDeviceList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultTerminalDeviceShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where hasExtraData is not null
        defaultTerminalDeviceShouldBeFound("hasExtraData.specified=true");

        // Get all the terminalDeviceList where hasExtraData is null
        defaultTerminalDeviceShouldNotBeFound("hasExtraData.specified=false");
    }
    ...
    public void updateTerminalDevice() throws Exception {
        ...
        assertThat(testTerminalDevice.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        ...
        assertThat(testTerminalDevice.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
