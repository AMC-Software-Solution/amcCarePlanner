...
public class TerminalDeviceResourceIT {
    ...
    public void createTerminalDevice() throws Exception {
        ...
        assertThat(testTerminalDevice.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    public void checkTenantIdIsRequired() throws Exception {
        ...
        // set the field null
        terminalDevice.setTenantId(null);
    ...
    @Test
    @Transactional
    public void getAllTerminalDevicesByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where tenantId equals to DEFAULT_TENANT_ID
        defaultTerminalDeviceShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the terminalDeviceList where tenantId equals to UPDATED_TENANT_ID
        defaultTerminalDeviceShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where tenantId not equals to DEFAULT_TENANT_ID
        defaultTerminalDeviceShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the terminalDeviceList where tenantId not equals to UPDATED_TENANT_ID
        defaultTerminalDeviceShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultTerminalDeviceShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the terminalDeviceList where tenantId equals to UPDATED_TENANT_ID
        defaultTerminalDeviceShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where tenantId is not null
        defaultTerminalDeviceShouldBeFound("tenantId.specified=true");

        // Get all the terminalDeviceList where tenantId is null
        defaultTerminalDeviceShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultTerminalDeviceShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the terminalDeviceList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultTerminalDeviceShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultTerminalDeviceShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the terminalDeviceList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultTerminalDeviceShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where tenantId is less than DEFAULT_TENANT_ID
        defaultTerminalDeviceShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the terminalDeviceList where tenantId is less than UPDATED_TENANT_ID
        defaultTerminalDeviceShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTerminalDevicesByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        terminalDeviceRepository.saveAndFlush(terminalDevice);

        // Get all the terminalDeviceList where tenantId is greater than DEFAULT_TENANT_ID
        defaultTerminalDeviceShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the terminalDeviceList where tenantId is greater than SMALLER_TENANT_ID
        defaultTerminalDeviceShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateTerminalDevice() throws Exception {
        ...
        assertThat(testTerminalDevice.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
