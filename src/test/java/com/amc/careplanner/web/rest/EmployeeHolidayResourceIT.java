...
public class EmployeeHolidayResourceIT {
    ...
    private static final HolidayStatus DEFAULT_HOLIDAY_STATUS = HolidayStatus.REQUESTED;
    private static final HolidayStatus UPDATED_HOLIDAY_STATUS = HolidayStatus.APPROVED;
    ...
    public void createEmployeeHoliday() throws Exception {
        ...
        assertThat(testEmployeeHoliday.getHolidayStatus()).isEqualTo(DEFAULT_HOLIDAY_STATUS);
        assertThat(testEmployeeHoliday.getNote()).isEqualTo(DEFAULT_NOTE);
        assertThat(testEmployeeHoliday.getRejectionReason()).isEqualTo(DEFAULT_REJECTION_REASON);
        assertThat(testEmployeeHoliday.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testEmployeeHoliday.getLastUpdatedDate()).isEqualTo(DEFAULT_LAST_UPDATED_DATE);
        assertThat(testEmployeeHoliday.getClientId()).isEqualTo(DEFAULT_CLIENT_ID);
        assertThat(testEmployeeHoliday.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    public void checkClientIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeHolidayRepository.findAll().size();
        // set the field null
        employeeHoliday.setClientId(null);
    ...
    @Test
    @Transactional
    public void getAllEmployeeHolidaysByHolidayStatusIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where holidayStatus equals to DEFAULT_HOLIDAY_STATUS
        defaultEmployeeHolidayShouldBeFound("holidayStatus.equals=" + DEFAULT_HOLIDAY_STATUS);

        // Get all the employeeHolidayList where holidayStatus equals to UPDATED_HOLIDAY_STATUS
        defaultEmployeeHolidayShouldNotBeFound("holidayStatus.equals=" + UPDATED_HOLIDAY_STATUS);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByHolidayStatusIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where holidayStatus not equals to DEFAULT_HOLIDAY_STATUS
        defaultEmployeeHolidayShouldNotBeFound("holidayStatus.notEquals=" + DEFAULT_HOLIDAY_STATUS);

        // Get all the employeeHolidayList where holidayStatus not equals to UPDATED_HOLIDAY_STATUS
        defaultEmployeeHolidayShouldBeFound("holidayStatus.notEquals=" + UPDATED_HOLIDAY_STATUS);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByHolidayStatusIsInShouldWork() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where holidayStatus in DEFAULT_HOLIDAY_STATUS or UPDATED_HOLIDAY_STATUS
        defaultEmployeeHolidayShouldBeFound("holidayStatus.in=" + DEFAULT_HOLIDAY_STATUS + "," + UPDATED_HOLIDAY_STATUS);

        // Get all the employeeHolidayList where holidayStatus equals to UPDATED_HOLIDAY_STATUS
        defaultEmployeeHolidayShouldNotBeFound("holidayStatus.in=" + UPDATED_HOLIDAY_STATUS);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByHolidayStatusIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where holidayStatus is not null
        defaultEmployeeHolidayShouldBeFound("holidayStatus.specified=true");

        // Get all the employeeHolidayList where holidayStatus is null
        defaultEmployeeHolidayShouldNotBeFound("holidayStatus.specified=false");
    }
    ...
    @Test
    @Transactional
    public void getAllEmployeeHolidaysByRejectionReasonIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where rejectionReason equals to DEFAULT_REJECTION_REASON
        defaultEmployeeHolidayShouldBeFound("rejectionReason.equals=" + DEFAULT_REJECTION_REASON);

        // Get all the employeeHolidayList where rejectionReason equals to UPDATED_REJECTION_REASON
        defaultEmployeeHolidayShouldNotBeFound("rejectionReason.equals=" + UPDATED_REJECTION_REASON);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByRejectionReasonIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where rejectionReason not equals to DEFAULT_REJECTION_REASON
        defaultEmployeeHolidayShouldNotBeFound("rejectionReason.notEquals=" + DEFAULT_REJECTION_REASON);

        // Get all the employeeHolidayList where rejectionReason not equals to UPDATED_REJECTION_REASON
        defaultEmployeeHolidayShouldBeFound("rejectionReason.notEquals=" + UPDATED_REJECTION_REASON);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByRejectionReasonIsInShouldWork() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where rejectionReason in DEFAULT_REJECTION_REASON or UPDATED_REJECTION_REASON
        defaultEmployeeHolidayShouldBeFound("rejectionReason.in=" + DEFAULT_REJECTION_REASON + "," + UPDATED_REJECTION_REASON);

        // Get all the employeeHolidayList where rejectionReason equals to UPDATED_REJECTION_REASON
        defaultEmployeeHolidayShouldNotBeFound("rejectionReason.in=" + UPDATED_REJECTION_REASON);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByRejectionReasonIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where rejectionReason is not null
        defaultEmployeeHolidayShouldBeFound("rejectionReason.specified=true");

        // Get all the employeeHolidayList where rejectionReason is null
        defaultEmployeeHolidayShouldNotBeFound("rejectionReason.specified=false");
    }
                @Test
    @Transactional
    public void getAllEmployeeHolidaysByRejectionReasonContainsSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where rejectionReason contains DEFAULT_REJECTION_REASON
        defaultEmployeeHolidayShouldBeFound("rejectionReason.contains=" + DEFAULT_REJECTION_REASON);

        // Get all the employeeHolidayList where rejectionReason contains UPDATED_REJECTION_REASON
        defaultEmployeeHolidayShouldNotBeFound("rejectionReason.contains=" + UPDATED_REJECTION_REASON);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByRejectionReasonNotContainsSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where rejectionReason does not contain DEFAULT_REJECTION_REASON
        defaultEmployeeHolidayShouldNotBeFound("rejectionReason.doesNotContain=" + DEFAULT_REJECTION_REASON);

        // Get all the employeeHolidayList where rejectionReason does not contain UPDATED_REJECTION_REASON
        defaultEmployeeHolidayShouldBeFound("rejectionReason.doesNotContain=" + UPDATED_REJECTION_REASON);
    }


    @Test
    @Transactional
    public void getAllEmployeeHolidaysByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where createdDate equals to DEFAULT_CREATED_DATE
        defaultEmployeeHolidayShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the employeeHolidayList where createdDate equals to UPDATED_CREATED_DATE
        defaultEmployeeHolidayShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultEmployeeHolidayShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the employeeHolidayList where createdDate not equals to UPDATED_CREATED_DATE
        defaultEmployeeHolidayShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where createdDate in DEFAULT_CREATED_DATE or UPDATED_CREATED_DATE
        defaultEmployeeHolidayShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the employeeHolidayList where createdDate equals to UPDATED_CREATED_DATE
        defaultEmployeeHolidayShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where createdDate is not null
        defaultEmployeeHolidayShouldBeFound("createdDate.specified=true");

        // Get all the employeeHolidayList where createdDate is null
        defaultEmployeeHolidayShouldNotBeFound("createdDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultEmployeeHolidayShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the employeeHolidayList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultEmployeeHolidayShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultEmployeeHolidayShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the employeeHolidayList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultEmployeeHolidayShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where createdDate is less than DEFAULT_CREATED_DATE
        defaultEmployeeHolidayShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the employeeHolidayList where createdDate is less than UPDATED_CREATED_DATE
        defaultEmployeeHolidayShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultEmployeeHolidayShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the employeeHolidayList where createdDate is greater than SMALLER_CREATED_DATE
        defaultEmployeeHolidayShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllEmployeeHolidaysByClientIdIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where clientId equals to DEFAULT_CLIENT_ID
        defaultEmployeeHolidayShouldBeFound("clientId.equals=" + DEFAULT_CLIENT_ID);

        // Get all the employeeHolidayList where clientId equals to UPDATED_CLIENT_ID
        defaultEmployeeHolidayShouldNotBeFound("clientId.equals=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByClientIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where clientId not equals to DEFAULT_CLIENT_ID
        defaultEmployeeHolidayShouldNotBeFound("clientId.notEquals=" + DEFAULT_CLIENT_ID);

        // Get all the employeeHolidayList where clientId not equals to UPDATED_CLIENT_ID
        defaultEmployeeHolidayShouldBeFound("clientId.notEquals=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByClientIdIsInShouldWork() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where clientId in DEFAULT_CLIENT_ID or UPDATED_CLIENT_ID
        defaultEmployeeHolidayShouldBeFound("clientId.in=" + DEFAULT_CLIENT_ID + "," + UPDATED_CLIENT_ID);

        // Get all the employeeHolidayList where clientId equals to UPDATED_CLIENT_ID
        defaultEmployeeHolidayShouldNotBeFound("clientId.in=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByClientIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where clientId is not null
        defaultEmployeeHolidayShouldBeFound("clientId.specified=true");

        // Get all the employeeHolidayList where clientId is null
        defaultEmployeeHolidayShouldNotBeFound("clientId.specified=false");
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByClientIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where clientId is greater than or equal to DEFAULT_CLIENT_ID
        defaultEmployeeHolidayShouldBeFound("clientId.greaterThanOrEqual=" + DEFAULT_CLIENT_ID);

        // Get all the employeeHolidayList where clientId is greater than or equal to UPDATED_CLIENT_ID
        defaultEmployeeHolidayShouldNotBeFound("clientId.greaterThanOrEqual=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByClientIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where clientId is less than or equal to DEFAULT_CLIENT_ID
        defaultEmployeeHolidayShouldBeFound("clientId.lessThanOrEqual=" + DEFAULT_CLIENT_ID);

        // Get all the employeeHolidayList where clientId is less than or equal to SMALLER_CLIENT_ID
        defaultEmployeeHolidayShouldNotBeFound("clientId.lessThanOrEqual=" + SMALLER_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByClientIdIsLessThanSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where clientId is less than DEFAULT_CLIENT_ID
        defaultEmployeeHolidayShouldNotBeFound("clientId.lessThan=" + DEFAULT_CLIENT_ID);

        // Get all the employeeHolidayList where clientId is less than UPDATED_CLIENT_ID
        defaultEmployeeHolidayShouldBeFound("clientId.lessThan=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByClientIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where clientId is greater than DEFAULT_CLIENT_ID
        defaultEmployeeHolidayShouldNotBeFound("clientId.greaterThan=" + DEFAULT_CLIENT_ID);

        // Get all the employeeHolidayList where clientId is greater than SMALLER_CLIENT_ID
        defaultEmployeeHolidayShouldBeFound("clientId.greaterThan=" + SMALLER_CLIENT_ID);
    }


    @Test
    @Transactional
    public void getAllEmployeeHolidaysByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultEmployeeHolidayShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the employeeHolidayList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultEmployeeHolidayShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultEmployeeHolidayShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the employeeHolidayList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultEmployeeHolidayShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultEmployeeHolidayShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the employeeHolidayList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultEmployeeHolidayShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllEmployeeHolidaysByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeHolidayRepository.saveAndFlush(employeeHoliday);

        // Get all the employeeHolidayList where hasExtraData is not null
        defaultEmployeeHolidayShouldBeFound("hasExtraData.specified=true");

        // Get all the employeeHolidayList where hasExtraData is null
        defaultEmployeeHolidayShouldNotBeFound("hasExtraData.specified=false");
    }
    ...
    public void updateEmployeeHoliday() throws Exception {
        ...
        assertThat(testEmployeeHoliday.getHolidayStatus()).isEqualTo(UPDATED_HOLIDAY_STATUS);
        assertThat(testEmployeeHoliday.getNote()).isEqualTo(UPDATED_NOTE);
        assertThat(testEmployeeHoliday.getRejectionReason()).isEqualTo(UPDATED_REJECTION_REASON);
        assertThat(testEmployeeHoliday.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testEmployeeHoliday.getLastUpdatedDate()).isEqualTo(UPDATED_LAST_UPDATED_DATE);
        assertThat(testEmployeeHoliday.getClientId()).isEqualTo(UPDATED_CLIENT_ID);
        assertThat(testEmployeeHoliday.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
