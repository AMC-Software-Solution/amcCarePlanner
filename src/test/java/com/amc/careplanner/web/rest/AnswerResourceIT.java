...
public class AnswerResourceIT {
    ...
    public void createAnswer() throws Exception {
        ...
        assertThat(testAnswer.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    @Test
    @Transactional
    public void getAllAnswersByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        answerRepository.saveAndFlush(answer);

        // Get all the answerList where tenantId equals to DEFAULT_TENANT_ID
        defaultAnswerShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the answerList where tenantId equals to UPDATED_TENANT_ID
        defaultAnswerShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllAnswersByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        answerRepository.saveAndFlush(answer);

        // Get all the answerList where tenantId not equals to DEFAULT_TENANT_ID
        defaultAnswerShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the answerList where tenantId not equals to UPDATED_TENANT_ID
        defaultAnswerShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllAnswersByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        answerRepository.saveAndFlush(answer);

        // Get all the answerList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultAnswerShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the answerList where tenantId equals to UPDATED_TENANT_ID
        defaultAnswerShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllAnswersByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        answerRepository.saveAndFlush(answer);

        // Get all the answerList where tenantId is not null
        defaultAnswerShouldBeFound("tenantId.specified=true");

        // Get all the answerList where tenantId is null
        defaultAnswerShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllAnswersByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        answerRepository.saveAndFlush(answer);

        // Get all the answerList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultAnswerShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the answerList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultAnswerShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllAnswersByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        answerRepository.saveAndFlush(answer);

        // Get all the answerList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultAnswerShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the answerList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultAnswerShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllAnswersByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        answerRepository.saveAndFlush(answer);

        // Get all the answerList where tenantId is less than DEFAULT_TENANT_ID
        defaultAnswerShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the answerList where tenantId is less than UPDATED_TENANT_ID
        defaultAnswerShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllAnswersByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        answerRepository.saveAndFlush(answer);

        // Get all the answerList where tenantId is greater than DEFAULT_TENANT_ID
        defaultAnswerShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the answerList where tenantId is greater than SMALLER_TENANT_ID
        defaultAnswerShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateAnswer() throws Exception {
        ...
        assertThat(testAnswer.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
