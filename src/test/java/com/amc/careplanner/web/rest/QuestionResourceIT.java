...
public class QuestionResourceIT {
    ...
    public void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getClientId()).isEqualTo(DEFAULT_CLIENT_ID);
        assertThat(testQuestion.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    @Test
    @Transactional
    public void getAllQuestionsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultQuestionShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the questionList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultQuestionShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllQuestionsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultQuestionShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the questionList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultQuestionShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllQuestionsByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where createdDate is less than DEFAULT_CREATED_DATE
        defaultQuestionShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the questionList where createdDate is less than UPDATED_CREATED_DATE
        defaultQuestionShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllQuestionsByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultQuestionShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the questionList where createdDate is greater than SMALLER_CREATED_DATE
        defaultQuestionShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllQuestionsByClientIdIsEqualToSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where clientId equals to DEFAULT_CLIENT_ID
        defaultQuestionShouldBeFound("clientId.equals=" + DEFAULT_CLIENT_ID);

        // Get all the questionList where clientId equals to UPDATED_CLIENT_ID
        defaultQuestionShouldNotBeFound("clientId.equals=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllQuestionsByClientIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where clientId not equals to DEFAULT_CLIENT_ID
        defaultQuestionShouldNotBeFound("clientId.notEquals=" + DEFAULT_CLIENT_ID);

        // Get all the questionList where clientId not equals to UPDATED_CLIENT_ID
        defaultQuestionShouldBeFound("clientId.notEquals=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllQuestionsByClientIdIsInShouldWork() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where clientId in DEFAULT_CLIENT_ID or UPDATED_CLIENT_ID
        defaultQuestionShouldBeFound("clientId.in=" + DEFAULT_CLIENT_ID + "," + UPDATED_CLIENT_ID);

        // Get all the questionList where clientId equals to UPDATED_CLIENT_ID
        defaultQuestionShouldNotBeFound("clientId.in=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllQuestionsByClientIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where clientId is not null
        defaultQuestionShouldBeFound("clientId.specified=true");

        // Get all the questionList where clientId is null
        defaultQuestionShouldNotBeFound("clientId.specified=false");
    }

    @Test
    @Transactional
    public void getAllQuestionsByClientIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where clientId is greater than or equal to DEFAULT_CLIENT_ID
        defaultQuestionShouldBeFound("clientId.greaterThanOrEqual=" + DEFAULT_CLIENT_ID);

        // Get all the questionList where clientId is greater than or equal to UPDATED_CLIENT_ID
        defaultQuestionShouldNotBeFound("clientId.greaterThanOrEqual=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllQuestionsByClientIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where clientId is less than or equal to DEFAULT_CLIENT_ID
        defaultQuestionShouldBeFound("clientId.lessThanOrEqual=" + DEFAULT_CLIENT_ID);

        // Get all the questionList where clientId is less than or equal to SMALLER_CLIENT_ID
        defaultQuestionShouldNotBeFound("clientId.lessThanOrEqual=" + SMALLER_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllQuestionsByClientIdIsLessThanSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where clientId is less than DEFAULT_CLIENT_ID
        defaultQuestionShouldNotBeFound("clientId.lessThan=" + DEFAULT_CLIENT_ID);

        // Get all the questionList where clientId is less than UPDATED_CLIENT_ID
        defaultQuestionShouldBeFound("clientId.lessThan=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllQuestionsByClientIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where clientId is greater than DEFAULT_CLIENT_ID
        defaultQuestionShouldNotBeFound("clientId.greaterThan=" + DEFAULT_CLIENT_ID);

        // Get all the questionList where clientId is greater than SMALLER_CLIENT_ID
        defaultQuestionShouldBeFound("clientId.greaterThan=" + SMALLER_CLIENT_ID);
    }


    @Test
    @Transactional
    public void getAllQuestionsByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultQuestionShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the questionList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultQuestionShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllQuestionsByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultQuestionShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the questionList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultQuestionShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllQuestionsByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultQuestionShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the questionList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultQuestionShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllQuestionsByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        questionRepository.saveAndFlush(question);

        // Get all the questionList where hasExtraData is not null
        defaultQuestionShouldBeFound("hasExtraData.specified=true");

        // Get all the questionList where hasExtraData is null
        defaultQuestionShouldNotBeFound("hasExtraData.specified=false");
    }
    /**
    ...
    public void updateQuestion() throws Exception {
        ...
        assertThat(testQuestion.getClientId()).isEqualTo(UPDATED_CLIENT_ID);
        assertThat(testQuestion.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
