...
public class ServiceUserLocationResourceIT {
    ...
    public void createServiceUserLocation() throws Exception {
        ...
        assertThat(testServiceUserLocation.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    public void checkTenantIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = serviceUserLocationRepository.findAll().size();
        // set the field null
        serviceUserLocation.setTenantId(null);
    ...
    @Test
    @Transactional
    public void getAllServiceUserLocationsByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserLocationRepository.saveAndFlush(serviceUserLocation);

        // Get all the serviceUserLocationList where tenantId equals to DEFAULT_TENANT_ID
        defaultServiceUserLocationShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserLocationList where tenantId equals to UPDATED_TENANT_ID
        defaultServiceUserLocationShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserLocationsByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserLocationRepository.saveAndFlush(serviceUserLocation);

        // Get all the serviceUserLocationList where tenantId not equals to DEFAULT_TENANT_ID
        defaultServiceUserLocationShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserLocationList where tenantId not equals to UPDATED_TENANT_ID
        defaultServiceUserLocationShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserLocationsByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserLocationRepository.saveAndFlush(serviceUserLocation);

        // Get all the serviceUserLocationList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultServiceUserLocationShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the serviceUserLocationList where tenantId equals to UPDATED_TENANT_ID
        defaultServiceUserLocationShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserLocationsByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserLocationRepository.saveAndFlush(serviceUserLocation);

        // Get all the serviceUserLocationList where tenantId is not null
        defaultServiceUserLocationShouldBeFound("tenantId.specified=true");

        // Get all the serviceUserLocationList where tenantId is null
        defaultServiceUserLocationShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllServiceUserLocationsByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserLocationRepository.saveAndFlush(serviceUserLocation);

        // Get all the serviceUserLocationList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultServiceUserLocationShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserLocationList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultServiceUserLocationShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserLocationsByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserLocationRepository.saveAndFlush(serviceUserLocation);

        // Get all the serviceUserLocationList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultServiceUserLocationShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserLocationList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultServiceUserLocationShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserLocationsByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        serviceUserLocationRepository.saveAndFlush(serviceUserLocation);

        // Get all the serviceUserLocationList where tenantId is less than DEFAULT_TENANT_ID
        defaultServiceUserLocationShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserLocationList where tenantId is less than UPDATED_TENANT_ID
        defaultServiceUserLocationShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserLocationsByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        serviceUserLocationRepository.saveAndFlush(serviceUserLocation);

        // Get all the serviceUserLocationList where tenantId is greater than DEFAULT_TENANT_ID
        defaultServiceUserLocationShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserLocationList where tenantId is greater than SMALLER_TENANT_ID
        defaultServiceUserLocationShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateServiceUserLocation() throws Exception {
        ...
        assertThat(testServiceUserLocation.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
