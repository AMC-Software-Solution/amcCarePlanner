...
public class ServiceUserResourceIT {
    ...
    public void createServiceUser() throws Exception {
        ...
        assertThat(testServiceUser.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceUsersByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where tenantId equals to DEFAULT_TENANT_ID
        defaultServiceUserShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserList where tenantId equals to UPDATED_TENANT_ID
        defaultServiceUserShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where tenantId not equals to DEFAULT_TENANT_ID
        defaultServiceUserShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserList where tenantId not equals to UPDATED_TENANT_ID
        defaultServiceUserShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultServiceUserShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the serviceUserList where tenantId equals to UPDATED_TENANT_ID
        defaultServiceUserShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where tenantId is not null
        defaultServiceUserShouldBeFound("tenantId.specified=true");

        // Get all the serviceUserList where tenantId is null
        defaultServiceUserShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllServiceUsersByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultServiceUserShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultServiceUserShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultServiceUserShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultServiceUserShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where tenantId is less than DEFAULT_TENANT_ID
        defaultServiceUserShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserList where tenantId is less than UPDATED_TENANT_ID
        defaultServiceUserShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where tenantId is greater than DEFAULT_TENANT_ID
        defaultServiceUserShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserList where tenantId is greater than SMALLER_TENANT_ID
        defaultServiceUserShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateServiceUser() throws Exception {
        ...
        assertThat(testServiceUser.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
