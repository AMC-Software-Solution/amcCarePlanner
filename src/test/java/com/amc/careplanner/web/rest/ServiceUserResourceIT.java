...
public class ServiceUserResourceIT {
    ...
    public void createServiceUser() throws Exception {
        ...
        assertThat(testServiceUser.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        ...
        assertThat(testServiceUser.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceUsersByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where createdDate equals to DEFAULT_CREATED_DATE
        defaultServiceUserShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserList where createdDate equals to UPDATED_CREATED_DATE
        defaultServiceUserShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultServiceUserShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserList where createdDate not equals to UPDATED_CREATED_DATE
        defaultServiceUserShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where createdDate in DEFAULT_CREATED_DATE or UPDATED_CREATED_DATE
        defaultServiceUserShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the serviceUserList where createdDate equals to UPDATED_CREATED_DATE
        defaultServiceUserShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where createdDate is not null
        defaultServiceUserShouldBeFound("createdDate.specified=true");

        // Get all the serviceUserList where createdDate is null
        defaultServiceUserShouldNotBeFound("createdDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllServiceUsersByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultServiceUserShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultServiceUserShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultServiceUserShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultServiceUserShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where createdDate is less than DEFAULT_CREATED_DATE
        defaultServiceUserShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserList where createdDate is less than UPDATED_CREATED_DATE
        defaultServiceUserShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultServiceUserShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserList where createdDate is greater than SMALLER_CREATED_DATE
        defaultServiceUserShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceUsersByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultServiceUserShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the serviceUserList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultServiceUserShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the serviceUserList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultServiceUserShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the serviceUserList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUsersByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserRepository.saveAndFlush(serviceUser);

        // Get all the serviceUserList where hasExtraData is not null
        defaultServiceUserShouldBeFound("hasExtraData.specified=true");

        // Get all the serviceUserList where hasExtraData is null
        defaultServiceUserShouldNotBeFound("hasExtraData.specified=false");
    }
    ...
    public void updateServiceUser() throws Exception {
        ...
        assertThat(testServiceUser.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        ...
        assertThat(testServiceUser.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
