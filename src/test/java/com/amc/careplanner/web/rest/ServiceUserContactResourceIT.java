...
public class ServiceUserContactResourceIT {
    ...
    public void createServiceUserContact() throws Exception {
        ...
        assertThat(testServiceUserContact.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        ...
        assertThat(testServiceUserContact.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceUserContactsByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where createdDate equals to DEFAULT_CREATED_DATE
        defaultServiceUserContactShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserContactList where createdDate equals to UPDATED_CREATED_DATE
        defaultServiceUserContactShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultServiceUserContactShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserContactList where createdDate not equals to UPDATED_CREATED_DATE
        defaultServiceUserContactShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where createdDate in DEFAULT_CREATED_DATE or UPDATED_CREATED_DATE
        defaultServiceUserContactShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the serviceUserContactList where createdDate equals to UPDATED_CREATED_DATE
        defaultServiceUserContactShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where createdDate is not null
        defaultServiceUserContactShouldBeFound("createdDate.specified=true");

        // Get all the serviceUserContactList where createdDate is null
        defaultServiceUserContactShouldNotBeFound("createdDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultServiceUserContactShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserContactList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultServiceUserContactShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultServiceUserContactShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserContactList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultServiceUserContactShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where createdDate is less than DEFAULT_CREATED_DATE
        defaultServiceUserContactShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserContactList where createdDate is less than UPDATED_CREATED_DATE
        defaultServiceUserContactShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultServiceUserContactShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the serviceUserContactList where createdDate is greater than SMALLER_CREATED_DATE
        defaultServiceUserContactShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceUserContactsByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultServiceUserContactShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the serviceUserContactList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserContactShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultServiceUserContactShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the serviceUserContactList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserContactShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultServiceUserContactShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the serviceUserContactList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultServiceUserContactShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where hasExtraData is not null
        defaultServiceUserContactShouldBeFound("hasExtraData.specified=true");

        // Get all the serviceUserContactList where hasExtraData is null
        defaultServiceUserContactShouldNotBeFound("hasExtraData.specified=false");
    }
    ...
    public void updateServiceUserContact() throws Exception {
        ...
        assertThat(testServiceUserContact.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        ...
        assertThat(testServiceUserContact.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
