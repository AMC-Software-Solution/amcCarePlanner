...
public class ServiceUserContactResourceIT {
    ...
    public void createServiceUserContact() throws Exception {
        ...
        assertThat(testServiceUserContact.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testServiceUserContact.getLastUpdatedDate()).isEqualTo(DEFAULT_LAST_UPDATED_DATE);
        assertThat(testServiceUserContact.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    public void checkTenantIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = serviceUserContactRepository.findAll().size();
        // set the field null
        serviceUserContact.setTenantId(null);
    ...
    @Test
    @Transactional
    public void getAllServiceUserContactsByEmailIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where email equals to DEFAULT_EMAIL
        defaultServiceUserContactShouldBeFound("email.equals=" + DEFAULT_EMAIL);

        // Get all the serviceUserContactList where email equals to UPDATED_EMAIL
        defaultServiceUserContactShouldNotBeFound("email.equals=" + UPDATED_EMAIL);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByEmailIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where email not equals to DEFAULT_EMAIL
        defaultServiceUserContactShouldNotBeFound("email.notEquals=" + DEFAULT_EMAIL);

        // Get all the serviceUserContactList where email not equals to UPDATED_EMAIL
        defaultServiceUserContactShouldBeFound("email.notEquals=" + UPDATED_EMAIL);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByEmailIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where email in DEFAULT_EMAIL or UPDATED_EMAIL
        defaultServiceUserContactShouldBeFound("email.in=" + DEFAULT_EMAIL + "," + UPDATED_EMAIL);

        // Get all the serviceUserContactList where email equals to UPDATED_EMAIL
        defaultServiceUserContactShouldNotBeFound("email.in=" + UPDATED_EMAIL);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByEmailIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where email is not null
        defaultServiceUserContactShouldBeFound("email.specified=true");

        // Get all the serviceUserContactList where email is null
        defaultServiceUserContactShouldNotBeFound("email.specified=false");
    }
                @Test
    @Transactional
    public void getAllServiceUserContactsByEmailContainsSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where email contains DEFAULT_EMAIL
        defaultServiceUserContactShouldBeFound("email.contains=" + DEFAULT_EMAIL);

        // Get all the serviceUserContactList where email contains UPDATED_EMAIL
        defaultServiceUserContactShouldNotBeFound("email.contains=" + UPDATED_EMAIL);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByEmailNotContainsSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where email does not contain DEFAULT_EMAIL
        defaultServiceUserContactShouldNotBeFound("email.doesNotContain=" + DEFAULT_EMAIL);

        // Get all the serviceUserContactList where email does not contain UPDATED_EMAIL
        defaultServiceUserContactShouldBeFound("email.doesNotContain=" + UPDATED_EMAIL);
    }
    ...
    @Test
    @Transactional
    public void getAllServiceUserContactsByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where tenantId equals to DEFAULT_TENANT_ID
        defaultServiceUserContactShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserContactList where tenantId equals to UPDATED_TENANT_ID
        defaultServiceUserContactShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where tenantId not equals to DEFAULT_TENANT_ID
        defaultServiceUserContactShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserContactList where tenantId not equals to UPDATED_TENANT_ID
        defaultServiceUserContactShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultServiceUserContactShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the serviceUserContactList where tenantId equals to UPDATED_TENANT_ID
        defaultServiceUserContactShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where tenantId is not null
        defaultServiceUserContactShouldBeFound("tenantId.specified=true");

        // Get all the serviceUserContactList where tenantId is null
        defaultServiceUserContactShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultServiceUserContactShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserContactList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultServiceUserContactShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultServiceUserContactShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserContactList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultServiceUserContactShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where tenantId is less than DEFAULT_TENANT_ID
        defaultServiceUserContactShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserContactList where tenantId is less than UPDATED_TENANT_ID
        defaultServiceUserContactShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServiceUserContactsByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        serviceUserContactRepository.saveAndFlush(serviceUserContact);

        // Get all the serviceUserContactList where tenantId is greater than DEFAULT_TENANT_ID
        defaultServiceUserContactShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the serviceUserContactList where tenantId is greater than SMALLER_TENANT_ID
        defaultServiceUserContactShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateServiceUserContact() throws Exception {
        ...
        assertThat(testServiceUserContact.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testServiceUserContact.getLastUpdatedDate()).isEqualTo(UPDATED_LAST_UPDATED_DATE);
        assertThat(testServiceUserContact.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
