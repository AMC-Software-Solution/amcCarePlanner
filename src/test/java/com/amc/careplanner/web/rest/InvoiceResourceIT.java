...
public class InvoiceResourceIT {
    ...
    @Test
    @Transactional
    public void getAllInvoicesByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);
    ...
    @Test
    @Transactional
    public void getAllInvoicesByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);

        // Get all the invoiceList where tenantId not equals to DEFAULT_TENANT_ID
        defaultInvoiceShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the invoiceList where tenantId not equals to UPDATED_TENANT_ID
        defaultInvoiceShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllInvoicesByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);
    ...
    @Test
    @Transactional
    public void getAllInvoicesByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);
    ...
    @Test
    @Transactional
    public void getAllInvoicesByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);
    ...
    @Test
    @Transactional
    public void getAllInvoicesByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);
    ...
    @Test
    @Transactional
    public void getAllInvoicesByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);
    ...
    @Test
    @Transactional
    public void getAllInvoicesByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        invoiceRepository.saveAndFlush(invoice);
