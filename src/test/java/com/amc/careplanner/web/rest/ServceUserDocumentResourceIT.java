...
public class ServceUserDocumentResourceIT {
    ...
    public void createServceUserDocument() throws Exception {
        ...
        assertThat(testServceUserDocument.getDocumentCode()).isEqualTo(DEFAULT_DOCUMENT_CODE);
        ...
        assertThat(testServceUserDocument.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    public void checkDocumentCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = servceUserDocumentRepository.findAll().size();
        // set the field null
        servceUserDocument.setDocumentCode(null);
    ...
    public void checkTenantIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = servceUserDocumentRepository.findAll().size();
        // set the field null
        servceUserDocument.setTenantId(null);
    ...
    @Test
    @Transactional
    public void getAllServceUserDocumentsByDocumentCodeIsEqualToSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where documentCode equals to DEFAULT_DOCUMENT_CODE
        defaultServceUserDocumentShouldBeFound("documentCode.equals=" + DEFAULT_DOCUMENT_CODE);

        // Get all the servceUserDocumentList where documentCode equals to UPDATED_DOCUMENT_CODE
        defaultServceUserDocumentShouldNotBeFound("documentCode.equals=" + UPDATED_DOCUMENT_CODE);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByDocumentCodeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where documentCode not equals to DEFAULT_DOCUMENT_CODE
        defaultServceUserDocumentShouldNotBeFound("documentCode.notEquals=" + DEFAULT_DOCUMENT_CODE);

        // Get all the servceUserDocumentList where documentCode not equals to UPDATED_DOCUMENT_CODE
        defaultServceUserDocumentShouldBeFound("documentCode.notEquals=" + UPDATED_DOCUMENT_CODE);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByDocumentCodeIsInShouldWork() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where documentCode in DEFAULT_DOCUMENT_CODE or UPDATED_DOCUMENT_CODE
        defaultServceUserDocumentShouldBeFound("documentCode.in=" + DEFAULT_DOCUMENT_CODE + "," + UPDATED_DOCUMENT_CODE);

        // Get all the servceUserDocumentList where documentCode equals to UPDATED_DOCUMENT_CODE
        defaultServceUserDocumentShouldNotBeFound("documentCode.in=" + UPDATED_DOCUMENT_CODE);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByDocumentCodeIsNullOrNotNull() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where documentCode is not null
        defaultServceUserDocumentShouldBeFound("documentCode.specified=true");

        // Get all the servceUserDocumentList where documentCode is null
        defaultServceUserDocumentShouldNotBeFound("documentCode.specified=false");
    }
                @Test
    @Transactional
    public void getAllServceUserDocumentsByDocumentCodeContainsSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where documentCode contains DEFAULT_DOCUMENT_CODE
        defaultServceUserDocumentShouldBeFound("documentCode.contains=" + DEFAULT_DOCUMENT_CODE);

        // Get all the servceUserDocumentList where documentCode contains UPDATED_DOCUMENT_CODE
        defaultServceUserDocumentShouldNotBeFound("documentCode.contains=" + UPDATED_DOCUMENT_CODE);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByDocumentCodeNotContainsSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where documentCode does not contain DEFAULT_DOCUMENT_CODE
        defaultServceUserDocumentShouldNotBeFound("documentCode.doesNotContain=" + DEFAULT_DOCUMENT_CODE);

        // Get all the servceUserDocumentList where documentCode does not contain UPDATED_DOCUMENT_CODE
        defaultServceUserDocumentShouldBeFound("documentCode.doesNotContain=" + UPDATED_DOCUMENT_CODE);
    }
    ...
    @Test
    @Transactional
    public void getAllServceUserDocumentsByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where tenantId equals to DEFAULT_TENANT_ID
        defaultServceUserDocumentShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the servceUserDocumentList where tenantId equals to UPDATED_TENANT_ID
        defaultServceUserDocumentShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where tenantId not equals to DEFAULT_TENANT_ID
        defaultServceUserDocumentShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the servceUserDocumentList where tenantId not equals to UPDATED_TENANT_ID
        defaultServceUserDocumentShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultServceUserDocumentShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the servceUserDocumentList where tenantId equals to UPDATED_TENANT_ID
        defaultServceUserDocumentShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where tenantId is not null
        defaultServceUserDocumentShouldBeFound("tenantId.specified=true");

        // Get all the servceUserDocumentList where tenantId is null
        defaultServceUserDocumentShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultServceUserDocumentShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the servceUserDocumentList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultServceUserDocumentShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultServceUserDocumentShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the servceUserDocumentList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultServceUserDocumentShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where tenantId is less than DEFAULT_TENANT_ID
        defaultServceUserDocumentShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the servceUserDocumentList where tenantId is less than UPDATED_TENANT_ID
        defaultServceUserDocumentShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllServceUserDocumentsByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        servceUserDocumentRepository.saveAndFlush(servceUserDocument);

        // Get all the servceUserDocumentList where tenantId is greater than DEFAULT_TENANT_ID
        defaultServceUserDocumentShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the servceUserDocumentList where tenantId is greater than SMALLER_TENANT_ID
        defaultServceUserDocumentShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateServceUserDocument() throws Exception {
        ...
        assertThat(testServceUserDocument.getDocumentCode()).isEqualTo(UPDATED_DOCUMENT_CODE);
        ...
        assertThat(testServceUserDocument.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
