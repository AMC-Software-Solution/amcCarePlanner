...
public class BranchResourceIT {
    ...
    @Test
    @Transactional
    public void getAllBranchesByTenantIsEqualToSomething() throws Exception {
        // Initialize the database
        branchRepository.saveAndFlush(branch);
        ...
        // Get all the branchList where tenant equals to tenantId
        defaultBranchShouldBeFound("tenantId.equals=" + tenantId);

        // Get all the branchList where tenant equals to tenantId + 1
        defaultBranchShouldNotBeFound("tenantId.equals=" + (tenantId + 1));
    }
