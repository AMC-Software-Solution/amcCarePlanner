...
public class TimesheetResourceIT {
    ...
    public void createTimesheet() throws Exception {
        ...
        assertThat(testTimesheet.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        ...
        assertThat(testTimesheet.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    @Test
    @Transactional
    public void getAllTimesheetsByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where createdDate equals to DEFAULT_CREATED_DATE
        defaultTimesheetShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the timesheetList where createdDate equals to UPDATED_CREATED_DATE
        defaultTimesheetShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultTimesheetShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the timesheetList where createdDate not equals to UPDATED_CREATED_DATE
        defaultTimesheetShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where createdDate in DEFAULT_CREATED_DATE or UPDATED_CREATED_DATE
        defaultTimesheetShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the timesheetList where createdDate equals to UPDATED_CREATED_DATE
        defaultTimesheetShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where createdDate is not null
        defaultTimesheetShouldBeFound("createdDate.specified=true");

        // Get all the timesheetList where createdDate is null
        defaultTimesheetShouldNotBeFound("createdDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllTimesheetsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultTimesheetShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the timesheetList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultTimesheetShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultTimesheetShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the timesheetList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultTimesheetShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where createdDate is less than DEFAULT_CREATED_DATE
        defaultTimesheetShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the timesheetList where createdDate is less than UPDATED_CREATED_DATE
        defaultTimesheetShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultTimesheetShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the timesheetList where createdDate is greater than SMALLER_CREATED_DATE
        defaultTimesheetShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllTimesheetsByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultTimesheetShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the timesheetList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultTimesheetShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultTimesheetShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the timesheetList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultTimesheetShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultTimesheetShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the timesheetList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultTimesheetShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where hasExtraData is not null
        defaultTimesheetShouldBeFound("hasExtraData.specified=true");

        // Get all the timesheetList where hasExtraData is null
        defaultTimesheetShouldNotBeFound("hasExtraData.specified=false");
    }

    @Test
    @Transactional
    public void getAllTimesheetsByTaskIsEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);
        ...
        // Get all the timesheetList where task equals to taskId
        defaultTimesheetShouldBeFound("taskId.equals=" + taskId);

        // Get all the timesheetList where task equals to taskId + 1
        defaultTimesheetShouldNotBeFound("taskId.equals=" + (taskId + 1));
    }
    ...
    public void updateTimesheet() throws Exception {
        ...
        assertThat(testTimesheet.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        ...
        assertThat(testTimesheet.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
