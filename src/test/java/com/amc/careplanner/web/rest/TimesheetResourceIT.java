...
public class TimesheetResourceIT {
    ...
    public void createTimesheet() throws Exception {
        ...
        assertThat(testTimesheet.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    @Test
    @Transactional
    public void getAllTimesheetsByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where tenantId equals to DEFAULT_TENANT_ID
        defaultTimesheetShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the timesheetList where tenantId equals to UPDATED_TENANT_ID
        defaultTimesheetShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where tenantId not equals to DEFAULT_TENANT_ID
        defaultTimesheetShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the timesheetList where tenantId not equals to UPDATED_TENANT_ID
        defaultTimesheetShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultTimesheetShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the timesheetList where tenantId equals to UPDATED_TENANT_ID
        defaultTimesheetShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where tenantId is not null
        defaultTimesheetShouldBeFound("tenantId.specified=true");

        // Get all the timesheetList where tenantId is null
        defaultTimesheetShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllTimesheetsByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultTimesheetShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the timesheetList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultTimesheetShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultTimesheetShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the timesheetList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultTimesheetShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where tenantId is less than DEFAULT_TENANT_ID
        defaultTimesheetShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the timesheetList where tenantId is less than UPDATED_TENANT_ID
        defaultTimesheetShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllTimesheetsByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        timesheetRepository.saveAndFlush(timesheet);

        // Get all the timesheetList where tenantId is greater than DEFAULT_TENANT_ID
        defaultTimesheetShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the timesheetList where tenantId is greater than SMALLER_TENANT_ID
        defaultTimesheetShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateTimesheet() throws Exception {
        ...
        assertThat(testTimesheet.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
