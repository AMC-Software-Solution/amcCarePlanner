...
public class EmergencyContactResourceIT {
    ...
    public void createEmergencyContact() throws Exception {
        ...
        assertThat(testEmergencyContact.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testEmergencyContact.getLastUpdatedDate()).isEqualTo(DEFAULT_LAST_UPDATED_DATE);
        assertThat(testEmergencyContact.getClientId()).isEqualTo(DEFAULT_CLIENT_ID);
        assertThat(testEmergencyContact.isHasExtraData()).isEqualTo(DEFAULT_HAS_EXTRA_DATA);
    }
    ...
    public void checkClientIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = emergencyContactRepository.findAll().size();
        // set the field null
        emergencyContact.setClientId(null);
    ...
    @Test
    @Transactional
    public void getAllEmergencyContactsByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where createdDate equals to DEFAULT_CREATED_DATE
        defaultEmergencyContactShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the emergencyContactList where createdDate equals to UPDATED_CREATED_DATE
        defaultEmergencyContactShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultEmergencyContactShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the emergencyContactList where createdDate not equals to UPDATED_CREATED_DATE
        defaultEmergencyContactShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where createdDate in DEFAULT_CREATED_DATE or UPDATED_CREATED_DATE
        defaultEmergencyContactShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the emergencyContactList where createdDate equals to UPDATED_CREATED_DATE
        defaultEmergencyContactShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where createdDate is not null
        defaultEmergencyContactShouldBeFound("createdDate.specified=true");

        // Get all the emergencyContactList where createdDate is null
        defaultEmergencyContactShouldNotBeFound("createdDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultEmergencyContactShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the emergencyContactList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultEmergencyContactShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultEmergencyContactShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the emergencyContactList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultEmergencyContactShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where createdDate is less than DEFAULT_CREATED_DATE
        defaultEmergencyContactShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the emergencyContactList where createdDate is less than UPDATED_CREATED_DATE
        defaultEmergencyContactShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultEmergencyContactShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the emergencyContactList where createdDate is greater than SMALLER_CREATED_DATE
        defaultEmergencyContactShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllEmergencyContactsByClientIdIsEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where clientId equals to DEFAULT_CLIENT_ID
        defaultEmergencyContactShouldBeFound("clientId.equals=" + DEFAULT_CLIENT_ID);

        // Get all the emergencyContactList where clientId equals to UPDATED_CLIENT_ID
        defaultEmergencyContactShouldNotBeFound("clientId.equals=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByClientIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where clientId not equals to DEFAULT_CLIENT_ID
        defaultEmergencyContactShouldNotBeFound("clientId.notEquals=" + DEFAULT_CLIENT_ID);

        // Get all the emergencyContactList where clientId not equals to UPDATED_CLIENT_ID
        defaultEmergencyContactShouldBeFound("clientId.notEquals=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByClientIdIsInShouldWork() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where clientId in DEFAULT_CLIENT_ID or UPDATED_CLIENT_ID
        defaultEmergencyContactShouldBeFound("clientId.in=" + DEFAULT_CLIENT_ID + "," + UPDATED_CLIENT_ID);

        // Get all the emergencyContactList where clientId equals to UPDATED_CLIENT_ID
        defaultEmergencyContactShouldNotBeFound("clientId.in=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByClientIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where clientId is not null
        defaultEmergencyContactShouldBeFound("clientId.specified=true");

        // Get all the emergencyContactList where clientId is null
        defaultEmergencyContactShouldNotBeFound("clientId.specified=false");
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByClientIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where clientId is greater than or equal to DEFAULT_CLIENT_ID
        defaultEmergencyContactShouldBeFound("clientId.greaterThanOrEqual=" + DEFAULT_CLIENT_ID);

        // Get all the emergencyContactList where clientId is greater than or equal to UPDATED_CLIENT_ID
        defaultEmergencyContactShouldNotBeFound("clientId.greaterThanOrEqual=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByClientIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where clientId is less than or equal to DEFAULT_CLIENT_ID
        defaultEmergencyContactShouldBeFound("clientId.lessThanOrEqual=" + DEFAULT_CLIENT_ID);

        // Get all the emergencyContactList where clientId is less than or equal to SMALLER_CLIENT_ID
        defaultEmergencyContactShouldNotBeFound("clientId.lessThanOrEqual=" + SMALLER_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByClientIdIsLessThanSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where clientId is less than DEFAULT_CLIENT_ID
        defaultEmergencyContactShouldNotBeFound("clientId.lessThan=" + DEFAULT_CLIENT_ID);

        // Get all the emergencyContactList where clientId is less than UPDATED_CLIENT_ID
        defaultEmergencyContactShouldBeFound("clientId.lessThan=" + UPDATED_CLIENT_ID);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByClientIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where clientId is greater than DEFAULT_CLIENT_ID
        defaultEmergencyContactShouldNotBeFound("clientId.greaterThan=" + DEFAULT_CLIENT_ID);

        // Get all the emergencyContactList where clientId is greater than SMALLER_CLIENT_ID
        defaultEmergencyContactShouldBeFound("clientId.greaterThan=" + SMALLER_CLIENT_ID);
    }


    @Test
    @Transactional
    public void getAllEmergencyContactsByHasExtraDataIsEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where hasExtraData equals to DEFAULT_HAS_EXTRA_DATA
        defaultEmergencyContactShouldBeFound("hasExtraData.equals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the emergencyContactList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultEmergencyContactShouldNotBeFound("hasExtraData.equals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByHasExtraDataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where hasExtraData not equals to DEFAULT_HAS_EXTRA_DATA
        defaultEmergencyContactShouldNotBeFound("hasExtraData.notEquals=" + DEFAULT_HAS_EXTRA_DATA);

        // Get all the emergencyContactList where hasExtraData not equals to UPDATED_HAS_EXTRA_DATA
        defaultEmergencyContactShouldBeFound("hasExtraData.notEquals=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByHasExtraDataIsInShouldWork() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where hasExtraData in DEFAULT_HAS_EXTRA_DATA or UPDATED_HAS_EXTRA_DATA
        defaultEmergencyContactShouldBeFound("hasExtraData.in=" + DEFAULT_HAS_EXTRA_DATA + "," + UPDATED_HAS_EXTRA_DATA);

        // Get all the emergencyContactList where hasExtraData equals to UPDATED_HAS_EXTRA_DATA
        defaultEmergencyContactShouldNotBeFound("hasExtraData.in=" + UPDATED_HAS_EXTRA_DATA);
    }

    @Test
    @Transactional
    public void getAllEmergencyContactsByHasExtraDataIsNullOrNotNull() throws Exception {
        // Initialize the database
        emergencyContactRepository.saveAndFlush(emergencyContact);

        // Get all the emergencyContactList where hasExtraData is not null
        defaultEmergencyContactShouldBeFound("hasExtraData.specified=true");

        // Get all the emergencyContactList where hasExtraData is null
        defaultEmergencyContactShouldNotBeFound("hasExtraData.specified=false");
    }
    ...
    public void updateEmergencyContact() throws Exception {
        ...
        assertThat(testEmergencyContact.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testEmergencyContact.getLastUpdatedDate()).isEqualTo(UPDATED_LAST_UPDATED_DATE);
        assertThat(testEmergencyContact.getClientId()).isEqualTo(UPDATED_CLIENT_ID);
        assertThat(testEmergencyContact.isHasExtraData()).isEqualTo(UPDATED_HAS_EXTRA_DATA);
    }
