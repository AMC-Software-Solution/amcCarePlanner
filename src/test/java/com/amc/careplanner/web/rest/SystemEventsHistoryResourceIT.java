...
public class SystemEventsHistoryResourceIT {
    ...
    public void createSystemEventsHistory() throws Exception {
        ...
        assertThat(testSystemEventsHistory.getTenantId()).isEqualTo(DEFAULT_TENANT_ID);
    }
    ...
    @Test
    @Transactional
    public void getAllSystemEventsHistoriesByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        systemEventsHistoryRepository.saveAndFlush(systemEventsHistory);

        // Get all the systemEventsHistoryList where tenantId equals to DEFAULT_TENANT_ID
        defaultSystemEventsHistoryShouldBeFound("tenantId.equals=" + DEFAULT_TENANT_ID);

        // Get all the systemEventsHistoryList where tenantId equals to UPDATED_TENANT_ID
        defaultSystemEventsHistoryShouldNotBeFound("tenantId.equals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllSystemEventsHistoriesByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        systemEventsHistoryRepository.saveAndFlush(systemEventsHistory);

        // Get all the systemEventsHistoryList where tenantId not equals to DEFAULT_TENANT_ID
        defaultSystemEventsHistoryShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the systemEventsHistoryList where tenantId not equals to UPDATED_TENANT_ID
        defaultSystemEventsHistoryShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllSystemEventsHistoriesByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        systemEventsHistoryRepository.saveAndFlush(systemEventsHistory);

        // Get all the systemEventsHistoryList where tenantId in DEFAULT_TENANT_ID or UPDATED_TENANT_ID
        defaultSystemEventsHistoryShouldBeFound("tenantId.in=" + DEFAULT_TENANT_ID + "," + UPDATED_TENANT_ID);

        // Get all the systemEventsHistoryList where tenantId equals to UPDATED_TENANT_ID
        defaultSystemEventsHistoryShouldNotBeFound("tenantId.in=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllSystemEventsHistoriesByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        systemEventsHistoryRepository.saveAndFlush(systemEventsHistory);

        // Get all the systemEventsHistoryList where tenantId is not null
        defaultSystemEventsHistoryShouldBeFound("tenantId.specified=true");

        // Get all the systemEventsHistoryList where tenantId is null
        defaultSystemEventsHistoryShouldNotBeFound("tenantId.specified=false");
    }

    @Test
    @Transactional
    public void getAllSystemEventsHistoriesByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        systemEventsHistoryRepository.saveAndFlush(systemEventsHistory);

        // Get all the systemEventsHistoryList where tenantId is greater than or equal to DEFAULT_TENANT_ID
        defaultSystemEventsHistoryShouldBeFound("tenantId.greaterThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the systemEventsHistoryList where tenantId is greater than or equal to UPDATED_TENANT_ID
        defaultSystemEventsHistoryShouldNotBeFound("tenantId.greaterThanOrEqual=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllSystemEventsHistoriesByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        systemEventsHistoryRepository.saveAndFlush(systemEventsHistory);

        // Get all the systemEventsHistoryList where tenantId is less than or equal to DEFAULT_TENANT_ID
        defaultSystemEventsHistoryShouldBeFound("tenantId.lessThanOrEqual=" + DEFAULT_TENANT_ID);

        // Get all the systemEventsHistoryList where tenantId is less than or equal to SMALLER_TENANT_ID
        defaultSystemEventsHistoryShouldNotBeFound("tenantId.lessThanOrEqual=" + SMALLER_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllSystemEventsHistoriesByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        systemEventsHistoryRepository.saveAndFlush(systemEventsHistory);

        // Get all the systemEventsHistoryList where tenantId is less than DEFAULT_TENANT_ID
        defaultSystemEventsHistoryShouldNotBeFound("tenantId.lessThan=" + DEFAULT_TENANT_ID);

        // Get all the systemEventsHistoryList where tenantId is less than UPDATED_TENANT_ID
        defaultSystemEventsHistoryShouldBeFound("tenantId.lessThan=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllSystemEventsHistoriesByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        systemEventsHistoryRepository.saveAndFlush(systemEventsHistory);

        // Get all the systemEventsHistoryList where tenantId is greater than DEFAULT_TENANT_ID
        defaultSystemEventsHistoryShouldNotBeFound("tenantId.greaterThan=" + DEFAULT_TENANT_ID);

        // Get all the systemEventsHistoryList where tenantId is greater than SMALLER_TENANT_ID
        defaultSystemEventsHistoryShouldBeFound("tenantId.greaterThan=" + SMALLER_TENANT_ID);
    }
    ...
    public void updateSystemEventsHistory() throws Exception {
        ...
        assertThat(testSystemEventsHistory.getTenantId()).isEqualTo(UPDATED_TENANT_ID);
    }
