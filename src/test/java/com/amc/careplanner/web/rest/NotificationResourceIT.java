...
public class NotificationResourceIT {
    ...
    @Test
    @Transactional
    public void getAllNotificationsByTenantIdIsEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByTenantIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);

        // Get all the notificationList where tenantId not equals to DEFAULT_TENANT_ID
        defaultNotificationShouldNotBeFound("tenantId.notEquals=" + DEFAULT_TENANT_ID);

        // Get all the notificationList where tenantId not equals to UPDATED_TENANT_ID
        defaultNotificationShouldBeFound("tenantId.notEquals=" + UPDATED_TENANT_ID);
    }

    @Test
    @Transactional
    public void getAllNotificationsByTenantIdIsInShouldWork() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByTenantIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByTenantIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByTenantIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByTenantIdIsLessThanSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    @Test
    @Transactional
    public void getAllNotificationsByTenantIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
