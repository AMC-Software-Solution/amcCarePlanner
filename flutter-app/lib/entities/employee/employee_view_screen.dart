        ...
        child: Column(
          ...
          children: <Widget>[
            Text('Id : ' + employee.id.toString(), style: Theme.of(context).textTheme.bodyText1,),
                Text('Tittle : ' + employee.tittle.toString(), style: Theme.of(context).textTheme.bodyText1,),
                ...
                Text('Gendder : ' + employee.gendder.toString(), style: Theme.of(context).textTheme.bodyText1,),
                ...
                Text('Employee Transport Mode : ' + employee.employeeTransportMode.toString(), style: Theme.of(context).textTheme.bodyText1,),
